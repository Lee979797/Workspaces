...
public class PzjgAction extends BaseAction {
	 ...
	 * 
	 * */
	public String findPzjgNameByCode(){
		Pzjg pzjg2 = new Pzjg();
		String code = getRequest().getParameter("pzjgdm");
		User user = (User) getSession().getAttribute("user");
		pzjg2.setPzjgdm(code);
		pzjg2.setBzjgdm(user.getBzjgCode());
		pzjg=pzjgService.findMcByDm(pzjg2);
		return SUCCESS;
	}
