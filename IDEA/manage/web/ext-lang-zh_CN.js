...
var  sfontList = ["Arial","Courier New","tahoma","Times New Roman","Verdana","宋体","黑体","隶书"];

if(Ext.form.HtmlEditor){
   Ext.apply(Ext.form.HtmlEditor.prototype, {
      fontFamilies:sfontList,
      defaultFont:"宋体",
      createlink:{title:"超链接",text:"对选择的文字进行超连接.",cls:"x-html-editor-tip"}
   });
}
