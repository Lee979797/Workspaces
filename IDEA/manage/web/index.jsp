                    ...
                    <td width="826" height="298" align="right" background="images/login2009-6_09.jpg">
                        <table width="250" border="0" align="right">
                            <tr>
                                <td>
                                    <fieldset>
                                        <legend><span class="STYLE5"><b>用户登陆</b></span></legend>
                                        <br>
                                        <s:form method="post" action="login.action" name="form1"
                                                onsubmit="return check()" theme="simple">
                                            <TABLE cellSpacing=0 cellPadding=0 align="center" width=210 border=0>
                                                <TBODY>
                                                <TR>
                                                    <TD height=15 align=center id="showMsgId"><font color="red"
                                                                                                    size="3"><s:property
                                                            value="tip"/></font></TD>
                                                </TR>
                                                <TR>
                                                    <TD align=left>
                                                        ...
                                                        <FONT class=form>
                                                            <!--<INPUT class=form value="<s:property value="userName" />"
                                                ...
                                                <TR>
                                                    <TD align=left>
                                                        ...
                                                        <FONT class=form>
                                                            <!--<INPUT class=form id="tjPassword" value="<s:property value="password" />"
                                                ...
                                                <TR>
                                                    <TD noWrap align=left>
                                                        <span style="padding-left: 47px;"><input id="tijiao"
                                                                                                 type="submit"
                                                                                                 value="提  交"/></span><span
                                                            style="padding-left: 20px;"><input type="reset"
                                                                                               value="重   置"/></span>
                                                    </TD>
                                                </TR>
                                                <TR>
                                                ...
                                                <TR>
                                                    <TD class=content_gray vAlign=top align=center>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A
                                                            href="javascript:;"><font color="#ffffff">忘记密码</font></A>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A
                                                            href="javascript:;"><font color="#ffffff">在线帮助</font></A>
                                                    </TD>
                                                </TR>
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="3">
                <tr>
                    <td width="81%" height="25">
                        <div valign="middle" class="STYLE1">
                            <div align="right">全国组织机构代码管理中心 版权所有</div>
                        </div>
                    </td>
                    <td width="19%">
                        <iframe src="checkOcxStatus.jsp" width="0" height="0" scrolling="no" frameborder="0"></iframe>
                    </td>
                </tr>
            </table>
