...
var searchcardnj = function() {
	...
	cardnjViewForm.getForm().load({
	    ...
	    params: { conditions: text_search_cardnj.getValue(),username:currentZzUsername,ywlxConditions:'',stateConditions:'22,24,6,16',centerid:currentZzUserBzjgdm,start:1,limit:1},	
