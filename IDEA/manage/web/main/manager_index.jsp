...
<head>
    ...
    <link rel="shortcut icon"
          href="<%=application.getAttribute("sysWebUrl")%>/images/favicon.ico"/>
...
<div id="loading">
    <div class="loading-indicator">
        <img src="${pageContext.request.contextPath}/images/loading.gif" width="39" height="39"
             style="margin-right:8px;float:left;vertical-align:top;"/>
        组织机构代码网上办证系统 V1.0 <br/> <span id="loading-msg">加载样式和图片...</span>
    </div>
</div>
...
<div id="bd">
    ...
    <link rel="stylesheet" type="text/css" media="all"
          href="<%=application.getAttribute("sysWebUrl")%>/resources/css/ext-all.css"/>
    <link rel="stylesheet" type="text/css" media="all"
          href="<%=application.getAttribute("sysWebUrl")%>/css/index.css"/>
    <link rel="stylesheet" type="text/css" media="all"
          href="<%=application.getAttribute("sysWebUrl")%>/css/global.css"/>
    <link rel="stylesheet" type="text/css"
          href="<%=application.getAttribute("sysWebUrl")%>/css/menus.css"/>
    <link rel="stylesheet" type="text/css"
          href="<%=application.getAttribute("sysWebUrl")%>/css/LovCombo.css"/>
    <script type="text/javascript">
        document.getElementById('loading-msg').innerHTML = '加载核心..';
    </script>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/adapter/ext/ext-base.js"></script>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/ext-all.js"></script>
    <script type="text/javascript">
        document.getElementById('loading-msg').innerHTML = '加载核心...';
    </script>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/js/LovCombo.js"></script>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/js/RowExpander.js"></script>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/js/NewFormLayout.js"></script>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/ext-lang-zh_CN.js"></script>

    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/js/Cardnjprint.js"></script>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/js/Cardread.js"></script>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/js/Cardwrite.js"></script>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/js/Cardprint.js"></script>

    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/validate/validate.js"></script>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/js/zzIncludeFunc.js"></script>
    ...
    %>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/report/zxt.js"></script>
    <link rel="stylesheet" type="text/css"
          href="<%=application.getAttribute("sysWebUrl")%>/report/zxtCss.css"/>
    <%
        }
        if ("zzXzqhYwReport".equals(strFuncFile)) {
    %>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/report/xzqhYwReport.js"></script>
    <link rel="stylesheet" type="text/css"
          href="<%=application.getAttribute("sysWebUrl")%>/report/xzqhYwReportCss.css"/>
    <%
        }
        if ("zzLeafHelp".equals(strFuncFile)) {
    %>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/js/StarHtmleditor.js"></script>
    <%
        }
        strFuncFile = strFuncFile + ".js";
    %>
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/js/<%=strFuncFile%>"></script>
    <%
        }
    %>
    <script type="text/javascript">
    ...
    <script type="text/javascript"
            src="<%=application.getAttribute("sysWebUrl")%>/js/main.js"></script>
    <script type="text/javascript">
        document.getElementById('loading-msg').innerHTML = '模块初始化...';
    </script>
</div>
<div id="header">
    <TABLE style="BACKGROUND-POSITION: 50% top; BACKGROUND-REPEAT: repeat-x" height=60 cellSpacing=0 cellPadding=0
           width="100%" background=images/bg.gif border=0>
        <TBODY>
        <TR>
            <TD>
                <TABLE style="BACKGROUND-POSITION: right top; BACKGROUND-REPEAT: no-repeat" height=60 cellSpacing=0
                       cellPadding=0 width="100%" background=images/bg_main.gif border=0>
                    <TBODY>
                    <TR>
                            ...
                            <TABLE height=60 cellSpacing=0 cellPadding=0 width=362 border=0>
                                ...
                                <TR>
                                    <TD height=20 align=left>
                                        ...
                                        <font color=#04436d>
													<span class="STYLE5">
													<span class="STYLE9">当前办证机构</span>
													&gt;&gt;
													<span class="STYLE9" id="">
													&nbsp;
													<s:property value="#session.user.bzjgName"/>
													<s:property value="#session.user.bzjgCode"/>
													</span>
													</span>
                                        </font>
                                    </TD>
                        ...
                        <TD vAlign=top align=right width="100%">
                            <TABLE height=21 cellSpacing=0 cellPadding=0 width=169
                                   bgColor=#000000 border=0>
                                <TBODY>
                                <TR>
                                    <TD vAlign=bottom align=left width=8><IMG
                                            onclick="javascript:hiddenTop();" height=4
                                            src="images/left_bottom.gif" width=4></TD>
                                    <TD><A style="cursor:hand"><IMG class=pointer
                                                                    onclick="javascript:LocationMainPage();" height=21
                                                                    src="images/home.gif" alert="显示系统主页" width=54
                                                                    border=0></A></TD>
                                    <TD><A style="cursor:hand"><IMG class=pointer
                                                                    onclick="javascript:luckPage();" height=21
                                                                    src="images/luck.gif" alert="锁定本地系统操作" width=54
                                                                    border=0></A></TD>
                                    <TD><A style="cursor:hand"><IMG class=pointer
                                                                    onclick="javascript:Fkey();" height=21
                                                                    src="images/quanping.gif" alert="全屏显示,可按F11键"
                                                                    width=54
                                                                    border=0></A></TD>
                                    <TD><A style="cursor:hand"><IMG class=pointer
                                                                    height=21 src="images/help.gif" width=54
                                                                    border=0></A></TD>
                                    <TD><A style="cursor:hand"><IMG
                                            onclick="javascript:ReLogin();" height=21
                                            src="images/exit.gif" alert="退出系统登录" width=54 border=0></A></TD>
                                    <TD vAlign=bottom align=right width=16><IMG height=4
                                                                                src="images/right_bottom.gif" width=4>
                                    </TD>
                                </TR>
                                </TBODY>
                            </TABLE>
