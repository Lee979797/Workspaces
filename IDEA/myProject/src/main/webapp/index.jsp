...
<head>
    ...
    <link href='http://fonts.useso.com//css?family=Lato:400,900,700,700italic,400italic,300italic,300,100italic,100,900italic'
          rel='stylesheet' type='text/css'>
    <link href='http://fonts.useso.com/css?family=Dosis:400,500,700,800,600,300,200' rel='stylesheet' type='text/css'>
    ...
    <div class="container">
        ...
        <div class="service_area">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="service_block">
                        <div class="service_icon icon2  delay-03s animated wow zoomIn"><span><i class="fa-comments"></i></span>
                        </div>
    ...
    <div class="client_area ">
        <div class="client_section animated  fadeInUp wow">
            ...
            <div class="quote_section">
                ...
                <p><b><img src="img/quote_sign_left.png" alt=""></b> Proin iaculis purus consequat sem cure digni ssim
...
<footer class="footer_section" id="contact">
    ...
    <div class="container">
        <div class="footer_bottom"> <span>Copyright © 2014 Butterfly
More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a
                    href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a>. </span></div>
    </div>
</footer>
<script type="text/javascript">
    $(document).ready(function (e) {
