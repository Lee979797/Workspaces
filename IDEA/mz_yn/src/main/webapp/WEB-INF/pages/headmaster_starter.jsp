            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a id="load-expenseType-id">报销类型</a></li>
                        <li><a id="load-project-id">报销项目</a></li>
                    </ul>
                </li>
            </ul>
            <!-- /.sidebar-menu -->
...
<script type="text/javascript">
    $(function () {
        ...
        $("#load-expenseType-id").click(function () {
            $(".container-fluid").load("expense/listUI.do", function () {
                $(".container-fluid").removeData();
            });//t=Math.random();
        });
        $("#load-project-id").click(function () {
            $(".container-fluid").load("project/listUI.do", function () {
                $(".container-fluid").removeData();
            });//t=Math.random();
        });
        $("#load-start1-id").click(function () {
            $(".container-fluid").load("user/headmasterStartUI.do", function () {
                $(".container-fluid").removeData();
            });//t=Math.random();
        });
