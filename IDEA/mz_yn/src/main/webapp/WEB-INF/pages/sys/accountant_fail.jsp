...
<script type="text/javascript">
    ...
    function setPrintBody(data) {
        ...
        var img = $("<div style='margin: 0 auto;width: 200px'><img src='/upload/" + data.bill + "' style='width: 200px'><div>");
        table.append(trs);
    ...
    function setModalBody(data) {
        ...
        var trs =
            ...
            "<tr><td>" + '审批状态' + "</td><td>" + '未通过' + "</td></tr>" +
            "<tr><td>" + '创建人' + "</td><td>" + data.createdUser + "</td></tr>" +
            "<tr><td>" + '创建时间' + "</td><td>" + data.createdTime + "</td></tr>" +
            "<tr><td>" + '审批人' + "</td><td>" + '<%=ShiroUtils.getPrincipal()%>' + "</td></tr>" +
            "<tr><td>" + '审批时间' + "</td><td>" + data.modifiedTime + "</td></tr>";
        table.append(trs);
    ...
    function setTableBodyRows(data) {
        ...
        for (var i in data) {
            ...
            var tds =
                ...
                "<td><button id='btnPrint' type='button' class='btn btn-default'>" + '打印' + "</button></td>";
            tr.append(tds);
            tBody.append(tr);
        }
    }
