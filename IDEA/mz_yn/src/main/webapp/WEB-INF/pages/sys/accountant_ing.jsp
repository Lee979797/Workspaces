        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer" id="modalFooter">
                    ...
                    <button class="btn btn-default btnPass" data-dismiss="modal">同意</button>
                    <button class="btn btn-default btnFail" data-dismiss="modal">驳回</button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#tbodyId").on("click", ".btn-view", doViewById);
