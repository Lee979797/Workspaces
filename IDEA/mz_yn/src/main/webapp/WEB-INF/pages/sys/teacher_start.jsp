...
<script type="text/javascript">
    $(function () {
        var url = "reimburse/findAllByUser.do";
    ...
    function setTableBodyRows(data) {
        ...
        var pBefore = "<p style='font-size: 72px'>"+data.before+"元</p>";
        var pIng = "<p style='font-size: 72px'>"+data.ing+"元</p>";
        var pAfter = "<p style='font-size: 72px'>"+data.after+"元</p>";
