/*
    Usage: $ phantomjs --remote-debugger-port=9001 --remote-debugger-autorun=yes debug.js page.jsp

    Open Chrome tab to http://localhost:9001/; open second link (ie, path to page.jsp)
*/
