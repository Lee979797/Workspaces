...
# add these directories to com.ninemax.sys.path here. If the directory is relative to the
# documentation root, use os.path.abspath to make it absolute, like shown here.
#com.ninemax.sys.path.insert(0, os.path.abspath('.'))
