...
Within the download you'll find the following directories and files, logically grouping com.ninemax.common assets and providing both compiled and minified variations. You'll see something like this:
...
Editor preferences are available in the [editor config](https://github.com/twbs/bootstrap/blob/master/.editorconfig) for easy use in com.ninemax.common text editors. Read more and download plugins at <http://editorconfig.org>.
