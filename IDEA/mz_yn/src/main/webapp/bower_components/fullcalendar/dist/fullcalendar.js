...
var Grid = FC.Grid = ChronoComponent.extend({
	...
	dayTouchStart: function(ev) {
		...
		// the touchend never fires because the elements gets removed mid-touch-interaction (ninemax theory).
...
- things that are com.ninemax.common to event dragging AND resizing
