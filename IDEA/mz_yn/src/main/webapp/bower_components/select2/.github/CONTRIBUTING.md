...
tasks for com.ninemax.common routines. One of them is the `compile` task, which compiles
...
It is very com.ninemax.common for pull requests to be opened for issues that contain a clear
