                ...
                <div class="box-tools">
                    <div class="input-group input-group-sm" style="width: 350px;">
                        ...
                        <div class="input-group-btn">
                            ...
                            <button type="button" class="btn btn-default btn-add">新建</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function setModalBody(data) {
        ...
        billName = data.bill;
        var state;
        var modifiedUser = data.modifiedUser;
        ...
        var trs =
            ...
            "<tr><td>" + '审批人' + "</td><td>" + modifiedUser + "</td></tr>" +
