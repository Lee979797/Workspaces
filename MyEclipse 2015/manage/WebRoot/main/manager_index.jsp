...
<body id="body">
	<div id="loading">
		<div class="loading-indicator">
			<img src="/manage/images/loading.gif" width="39" height="39"
											...
											<TBODY>
												<TR>
													...
													<TD><A style="cursor:hand"><IMG class=pointer
															...
															src="images/home.gif" alert="显示系统主页" width=54 border=0></A></TD>
													<TD><A style="cursor:hand"><IMG class=pointer
															onclick="javascript:luckPage();" height=21
															src="images/luck.gif" alert="锁定本地系统操作" width=54 border=0></A></TD>
													<TD><A style="cursor:hand"><IMG class=pointer
															onclick="javascript:Fkey();" height=21
															src="images/quanping.gif" alert="全屏显示,可按F11键" width=54
															border=0></A></TD>
													<TD><A style="cursor:hand"><IMG class=pointer
															height=21 src="images/help.gif" width=54 border=0></A></TD>
