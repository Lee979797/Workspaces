...
var FCKUrlRewriteCommand=function(){this.Name='UrlRewrite';};
FCKUrlRewriteCommand.prototype.Execute = function(){FCK.InsertHtml('[GoToUrl][/GoToUrl]');} 
FCKUrlRewriteCommand.prototype.GetState = function(){return FCK_TRISTATE_OFF;} 
FCKCommands.RegisterCommand( 'UrlRewrite', new FCKUrlRewriteCommand('UrlRewrite')) ; 
var UrlRewriteItem = new FCKToolbarButton( 'UrlRewrite', 'Go To', null, null, false, true ) ; 
UrlRewriteItem.IconPath = FCKConfig.PluginsPath + 'anchor.gif' ; 
FCKToolbarItems.RegisterItem( 'UrlRewrite', UrlRewriteItem ) ;
