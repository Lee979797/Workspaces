...
<%
    ...
    ArrayList<SystemMessageTO> sysMessList = sysMessBus.listAdministrativeNoticeOneMonth(content, pageNo, pageSize, pageComponent);
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr class="<%=(rowNumber%2==1?"list_tr":"list_tr2") %>">
                    ...
                    <td align="center" width="8%"><a title="查看"
                                                     href="/product/jsp/frame/detail_news.jsp?id=<%=sysMessage.getSys_id() %>"><img
