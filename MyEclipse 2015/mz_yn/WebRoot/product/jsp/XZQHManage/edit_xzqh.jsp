...
<head>
    ...
    <script type="text/javascript">
        function fCheckValue() {
            var jgmc, xzqh, sjxzqh, zslsh, jc, mc;
            ...
            <c:if test="${(source ne 'update_xzqh')}">
            ...
            if (document.getElementById("njfs_dq").checked && qsrq.val() > obj.val()) {
        ...
        function checkUsed(zrxzqh) {
            dwr.engine.setAsync(false);
            var flag = true;
            zrxzqhBs.findByDm(zrxzqh.value, function (xzqh) {
                if (xzqh != null) {
                    flag = false;
                    document.getElementById("prop").innerHTML = "办证机构已经存在，请重新填写！";
                } else {
                    flag = true;
...
<tr>
    ...
    <td class=td1 align="left" >
        <input type="text" name="zrxzqh.xzqh" id="xzqh" value="${zrxzqh.xzqh}"
               size="35" maxlength="6" readonly="readonly" style="BACKGROUND-COLOR: #e0e0e0;"/><%--&nbsp;<span id="prop" style="color: #ff0000;">*</span>--%>
    </td>
...
<tr>
    ...
    <td class=td1 align="left" style="position:relative;display:block;overflow:visible;">
        <input name="zrxzqh.jgdm" id="jgdm" type="text" size="35" value="${fn:trim(zrxzqh.jgdm)}"
               maxlength="9"/>&nbsp;<span style="color: #FF0000;">*</span>
...
<tr>
    ...
    <td class=td1 align="left" >
        <select name="zrxzqh.zdlevel" id="zdlevel" style="width: 210px">
            <c:if test="${fn:trim(fn:substring(zrxzqh.xzqh,2,6) eq '0000' )}">
                <option value="0" selected>中心级</option>
            </c:if>
            <c:if test="${fn:trim(fn:substring(zrxzqh.xzqh,2,6) ne '0000' and fn:substring(zrxzqh.xzqh,4,6) eq '00' )}">
                <option value="1" selected>地市级</option>
            </c:if>
            <c:if test="${fn:trim(fn:substring(zrxzqh.xzqh,2,6) ne '0000' and fn:substring(zrxzqh.xzqh,4,6) ne '00' )}">
    ...
    <td class=td1 align="left" width="26%">
        <input name="zrxzqh.sjxzqh" id="sjxzqh" type="text" size="35"
               ...
               value="${fn:trim((source eq 'update_xzqh')?zrxzqh.sjxzqh:((fn:substring(zrxzqh.xzqh,2,6) eq '0000')?zrxzqh.xzqh:(fn:substring(zrxzqh.xzqh,4,6) eq '00')?fn:replace(zrxzqh.xzqh,fn:substring(zrxzqh.xzqh,2,6) ,'0000' ):( fn:replace(zrxzqh.xzqh,fn:substring(zrxzqh.xzqh,4,6) ,'00'))))}">
        <span style="color: #FF0000; ">*</span>
    </td>
</tr>
<tr>
    ...
    <td class=td1 align="left" style="position:relative;display:block;overflow:visible;">
        <input name="zrxzqh.zsbh" id="zslsh" type="text" readonly="readonly" size="35" value="${fn:trim(zrxzqh.zsbh)}"
               maxlength="6">&nbsp;<span style="color: #FF0000;"></span>
    ...
    <td class=td1 align="left" style="position:relative;display:block;overflow:visible;">
        <input name="zrxzqh.jgmc" id="jgmc" type="text" size="35" value="${fn:trim(zrxzqh.jgmc)}"
               maxlength="60">&nbsp;<span style="color: #FF0000;">*</span>
...
<c:if test="${!zrxzqh.bzjgflag}">
    <tr>
        ...
        <td class=td1 align="left" width="26%">
            <input type="radio" name="zrxzqh.fmflag" value="true"  ${zrxzqh.fmflag ? "checked":""}>
            是
            <input type="radio" name="zrxzqh.fmflag" value="false" ${zrxzqh.fmflag ? "":"checked"}>
            否
        </td>
...
<tr>
    ...
    <td align="left" class=td1>
        ...
        <input type="radio" name="zrxzqh.njtsbz"   ${zrxzqh.njtsbz ?'':'checked'} value="false"> 隐藏
    </td>
