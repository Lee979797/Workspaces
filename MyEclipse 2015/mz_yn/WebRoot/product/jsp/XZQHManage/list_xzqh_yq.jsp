...
<form name="searchForm" method="post" action="/bsweb/xzqhManage_lissc_xzqh_yq.action">
    <div class="list_box">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr class="list_table_top">
                ...
                <td class="list_table_top_td" align="center">延期设置
                </td>
            ...
            <c:forEach varStatus="i" var="cf" items="${zrxzqhs}">
                <tr ${(i.count % 2 eq 1)?"class='list_tr'":"class='list_tr2'" }>
                    ...
                    <td align="center">
                        <a href="/bsweb/xzqhManage_yq?zrxzqh.xzqh=${cf.xzqh}">
