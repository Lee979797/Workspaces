...
<TR>
    ...
    <TD class="td1" style="position:relative;display:block;overflow:visible;">
        ...
        <INPUT
                ...
                style=" width:180%; position:absolute; BACKGROUND-COLOR: #e0e0e0;"   readonly="true"/>
    ...
    <TD class="td1" style="position:relative;display:block;overflow:visible;">
        <INPUT
              onblur="this.className='input_off';trimIntputValue(this);return judgeFddbrZjh(${jglx });"
                  onpaste=" showLength(document.getElementById('zjhm'), document.getElementById('zjhmlength'), 18);" onkeyup="onlySfzh(this);showLength(document.getElementById('zjhm'), document.getElementById('zjhmlength'), 18);" name="zjhm" name="zjhm"
                maxLength="18"
...
<tr>
    ...
    <TD class="td1">
        <INPUT 
               ...
               style="width:200px;BACKGROUND-COLOR: #e0e0e0;"  readonly="true" />
        <A hideFocus onclick="" href="javascript:void(0)">
...
<tr>
    ...
    <td class=td1>
    <c:set var="bzDate1" value="<%=DateUtil.strToDate(bzDate)%>"/>
        <INPUT onfocus="this.className='input_on';WdatePicker({el:$dp.$('yxqxs')}); "onclick="WdatePicker({el:$dp.$('yxqxs')});"
               ...
               value="<fmt:formatDate value='${bzDate1 }' pattern='yyyy-MM-dd'/>"
               />
   ...
   <TD class="td1" align="right">
    ...
    <TD class="td1">
      <c:set var="bzDate1" value="<%=DateUtil.strToDate(validate)%>"/>
        <INPUT onfocus="this.className='input_on';WdatePicker({el:$dp.$('zfrq')});"
               maxLength="10" size="23"
               name="tzfrq" id="zfrq"  value="<fmt:formatDate value='${bzDate1 }' pattern='yyyy-MM-dd'/>" style="width:200px;BACKGROUND-COLOR: #e0e0e0;"  readonly="true"
...
<TR>
    ...
    <TD class="td1" colSpan="3">
        <INPUT 
               ...
               name="jgdz" id="jgdz" value="<%=tJgdm.getJgdz()==null?"":tJgdm.getJgdz()%>" style="width:75%;BACKGROUND-COLOR: #e0e0e0;"
...
<TR>
    ...
    %>
      ...
      <TD class="td1" style="position:relative;display:block;overflow:visible;">
      <SELECT name="jjhlx" id="jjhlx" style="width:200px" disabled="disabled"/>
...
%>
   ...
   活动地域
    ...
    <%-- 以下是原版的活动地域，默认是通过的登录用户的办证机构代码获取的
    <td class=td1>
        <INPUT 
               maxLength=120 size="158"
               name="hddy" id="hddy" value="${bzjgdmMap[fn:trim(sysUser.bzjgdm)]}" style="z-index: 100; position: relative; width:200px;BACKGROUND-COLOR: #e0e0e0;" />
       <span style="color:red">*</span>
    </td> --%>
    <!-- xiaruibo  20170627 将活动地域改为从数据的活动地域中获取，而不是通过登录用户的办证机构代码获取了 -->
    <td class=td1>
        <INPUT 
               maxLength=120 size="158"
               name="hddy" id="hddy" value="<%=tJgdm.getHddy()==null?"":tJgdm.getHddy()%>" style="z-index: 100; position: relative; width:200px;BACKGROUND-COLOR: #e0e0e0;" />
       <span style="color:red">*</span>
    </td>
...
%>
  ...
  <TD class="td1" style="position:relative;display:block;overflow:visible;">
      <SELECT name="jjlx2011" id="jjlx2011" style="width:200px" disabled="disabled"/>
        <c:forEach items="${jjlx}" var="jjlx">
...
<TR>
    ...
    <TD class="td1" colSpan="3">
        <TEXTAREA onblur="trimIntputValue(this);"
                  ...
                  rows="3" cols="129"
                  readonly="true"
                  style="width:75%;margin-top:3px;BACKGROUND-COLOR: #e0e0e0;"><%=tJgdm.getJyfw() == null ? "" : tJgdm.getJyfw().trim()%>
        </TEXTAREA>
            <span style="color:red">*</span>
...
<TR>
    ...
    <TD class="td1" style="position:relative;display:block;overflow:visible;">
        ...
        onkeyup="onlyDecimalTel(this);;return onCharsChange_frsj(this);showLength(document.getElementById('mobile'), document.getElementById('mobilelength'), 18);" onpaste="return onCharsChange_frsj(this);showLength(document.getElementById('mobile'), document.getElementById('mobilelength'), 18);"
...
<tr>
 <td class=td1 align=right>
    ...
    <td class=td1>
        <input name="tbrlxfs" id="tbrlxfs" type="text"  maxLength="25" 
...
<tr>
    ...
    <td class=td1 colSpan=3>
        <input name="memo" id="memo" type="text"  style="width:75%;" maxLength="500"
               value="${tJgdm.memo }">
        <span id="pzjginfo"></span>
    </td>
    </tr>
