...
<head>
    ...
    <script type="text/javascript" src="/js/delete_ajax.js"></script> 
...
<div class="page_top_fixed">
    ...
    <div align="right" style="width: 30% ; float: right;">
       <form action="/bsweb/statistics_delete_by_tyshxydm">
       	<input type="hidden" value="${tJgdm.tyshxydm }" id="tyshxydm" name="tyshxydm"/>
        <input class="newBtn1" type="submit" id="delete_button" onclick="javascript:return delete_jg()" value="删除"/>&nbsp;         
       </form>        
