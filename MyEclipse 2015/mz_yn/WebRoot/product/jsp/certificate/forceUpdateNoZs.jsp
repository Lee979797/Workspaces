...
<body>
<div class="page_top">发证 &gt;&gt; 常用工具 &gt;&gt; 非证书项强制修改</div>
<div id="list_main">
<form name="thisForm" method="post" action="/bsweb/certificate_forceUpdatePageNoZs.action" onsubmit="return fCheckValue();">
  <div class="list_box">
  <div class="list_box_top" style="text-align: center;">
        机构代码：<input name="jgdm" type="text" class="input_120" onkeyup="rightValues(this);" maxlength="9" id="jgdm"  />
