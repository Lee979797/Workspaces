...
function checkCode(jgdm,ywlsh){
    ...
    if(!codeflag){
        window.location.href="/bsweb/certificate_search.action?ywlsh="+ywlsh+"&jgdm="+jgdm+"&source=update&bzjgdm=${sysUser.bzjgdm}&pageno=${pageno}&rowNumsView=${rowNumsView}";
    }
}
</script>
</head>
<body>
<div class="page_top">发证 &gt;&gt; 申请表修改 &gt;&gt; 申请表修改</div>
     ...
     <table width="100%" border="0" cellpadding="0" cellspacing="0">
      	...
      	<c:forEach varStatus="i" var="ywlc" items="${ywlcList}">
      		<tr ${i.count % 2==1?"class='list_tr'":"class='list_tr2'" }>
                ...
                <td align="center"><img src="../../images/icon_edit.gif" width="16" height="16" onclick="checkCode('${ywlc.jgdm}','${ywlc.ywlsh}');" style="cursor:pointer" title="修改"/></td>
      		</tr>
      	</c:forEach>
    </table>
  </div>
