...
<%
    ...
    Date yyqxz=DateUtil.strToDate(validate);
    System.out.println(yyqxz);
...
<div class="page_top_fixed" style="background:#F8F8F8">
    <div style=" float: left;"><strong>登记 &gt;&gt;    <c:if test='${1 eq jglx}'>
    ...
    <div align="right" style="width: 30% ; float: right;">
        ...
        <%if ("3".equals(formType)) {%>
        <INPUT class="newBtn1" onClick="submmit()" type=button value="换 证" name="btok"/>
        <%}%>
        <%if (!"3".equals(formType)) {%>
...
<form method="post" action="/bsweb/certificate_<%=action%>.action" name="busForm">
    ...
    <INPUT type="hidden" name="isxb" id="isxb" value="hz"/>
   ...
   %>
                        <TABLE class=tableBorder0 cellSpacing=0 cellPadding=5 align=center border=0 width="100%"
                            ...
                            <TR>
                                ...
                                <TD class=td1>
                                 <INPUT readonly="true"  size=28 name="tyshxydm" id="tyshxydm" value="${tJgdm.tyshxydm }"
                            ...
                            <%@ include file="common_edit_choose1.jsp" %>
		...
		<SELECT name="wjlyy" id="wjlyy" style="width:300px"/>
		 	<c:forEach items="${yyList}" var="yy">
                    ...
                    <div>
                    	...
                    	<input type="hidden" name="fzr.id" value="${list.lsh }"/>
								<tr>
									...
									<td class=td1>
										<input type="text" id="fzrXm" name="fzr.xm" value="${list.xm }" maxlength="50" style="z-index: 100; position: relative; width:200px;">
									...
									<td class=td1 align="right">&nbsp;
										...
										<td class=td1>
										<input type="text" id="fzrZjhm" maxlength="18"  name="fzr.zjhm" value="${list.zjhm }" onpaste=" showFzrLength();" onkeyup="onlySfzh(this);showFzrLength();">
										<span style="color:red">*</span>
								...
								<tr>
									...
									<td class=td1>
										<input type="text" id="fzrLxdh" name="fzr.lxdh" value="${list.lxdh }" onpaste="showDhLength();" onkeyup="onlyDecimalTel(this);showDhLength();" maxlength="25" style="z-index: 100; position: relative; width:200px;">
									...
									<td class=td1>
										<input type="text" id="fzrMobile" name="fzr.lxmobile" onkeyup="onlyDecimalTel(this);showMobileLength();" onafterpaste="onlyDecimalZero(this);showMobileLength();" value="${list.lxmobile }" maxlength="11" >
														       <INPUT class="num no-border-bx" name="fzrsjlength" id="fzrsjlength" tabIndex=100 readOnly size=4 value="0" name="charsmonitor"/>
              							<script type="text/javascript">
               							showMobileLength1();
        								</script>
									</td>
                    ...
                    <div class="listbtn">
                        ...
                        <%if ("3".equals(formType)) {%>
                        <INPUT class="newBtn1" onClick="submmit()" type=button value="换 证"
                               name="btok"/>&nbsp;<INPUT class="newBtn1" type=button onClick="add_div()" value="添加负责人"/>
                        <%}%>
                        <%if (!"3".equals(formType)) {%>
