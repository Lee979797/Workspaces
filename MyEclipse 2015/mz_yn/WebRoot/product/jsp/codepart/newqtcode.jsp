...
<head>
    ...
    <script type="text/javascript">
        function verifyCode(obj) {
            if (obj.value && obj.value.length > 0 && !(/^[A-Z0-9]{1,8}$/.test(obj.value))) {
        ...
        function fCheckValue() {
            ...
            var flag = false;
            var nub = 0;
            codePart.getMdsl(qsmd, jzmd, function (num) {
                if (num > 20000) {
                    flag = false;
...
<body>
<div class="page_top">码段 &gt;&gt; 码段管理 &gt;&gt; 其他码段录入</div>
<form name="frmThis" method="post" action="/bsweb/codenewqtcode.action">
                    ...
                    <div class="list listblue">
                        <TABLE class=tableBorder0 cellSpacing=0 cellPadding=0 align=center border=0 width="50%"
                            ...
                            <tr class="table1_tr1">
                                ...
                                <td width="60%">
                                    <input type="text" name="qtmdsource.qsmd" id="qsmd" maxlength="8"
                                           onkeyup="verifyCode(this)" onblur="verifyCode(this)" isnull="false"
                                           size="30" class="page_input2"/>
                                </td>
                            </tr>
                            <tr class="table1_tr1">
                                <td class="table1_td1" align="right">截止码段：</td>
                                <td>
                                    <input type="text" name="qtmdsource.jzmd" id="jzmd" maxlength="8" isnull="false"
                                           onkeyup="verifyCode(this)" onblur="verifyCode(this)" size="30"
                                           class="page_input2"/>
                                </td>
                            </tr>
                            <tr class="table1_tr1">
                                <td class="table1_td1" align="right">码段类型：</td>
                                <td><select name="qtmdsource.mdtype" id="mdtype" style="width: 188px;">
                                    <option></option>
                                    <option value="4">其&nbsp;他</option>
                                    <option value="5">省间迁入</option>
                                </select>
                                </td>
                            </tr>
                        </table>
