...
<head>
    ...
    <script type='text/javascript'
            src="<%=request.getContextPath() %>/product/jsp/frame/js/calendar/WdatePicker.js"></script>
    ...
    <script type="text/javascript">
        ...
        function userExportData() {
            window.location.href = "/bsweb/log_userExport.action";
        }
    </script>
</head>
<body>
<div class="page_top">系统 &gt;&gt; 日志查询 &gt;&gt; 用户操作日志</div>
<form name="searchForm" method="post" action="/bsweb/log_userOperList.action">
    ...
    <div id="list_main">
        <div class="list_box">
            <div class="list_box_top">
                ...
                <br/> 开始日期：<input id="CalendarSelector1" readOnly name="startDate" type="text" value="${startDate}"
                                  class="input_120" onfocus="WdatePicker({el:'CalendarSelector1'})"/><img
                    src="${requestScope.pageContext}/product/jsp/images/icon_day.gif" style="cursor:pointer;"
                    align=absMiddle
                    onclick="WdatePicker({el:'CalendarSelector1'})"/>
                结束日期：<input id="CalendarSelector2" readOnly name="endDate" value="${endDate}" type="text"
                ...
                <%--   <input name="exportBtn" type="button" class="newBtn1" id="exportBtn" value="导 出" onclick="userExportData();" />--%>
            </div>
                ...
                <tr class="list_table_top">
                    ...
                    <c:if test="${orderbyColum eq 'name'}">
                        <td class="list_table_top_td">
                            ...
                            <div class="jt_box" style="float:right">
                                <c:if test="${orderbyMethod eq 'desc'}">
                                    <a href="#" onclick="pageSort('name','asc')"><img src="../images/jt_2.gif"
                                                                                      width="16" height="16"
                                                                                      title="排序字段"/></a>
                                </c:if>
                                <c:if test="${orderbyMethod ne 'desc'}">
                                    <a href="#" onclick="pageSort('name','desc')"><img src="../images/jt_1.gif"
                                                                                       width="16" height="16"
                                                                                       title="排序字段"/></a>
                                </c:if>
                            </div>
                    ...
                    <c:if test="${orderbyColum ne 'name'}">
                        <td class="list_table_top_td">
                            <div style="float:left">操作员</div>
                            <div class="jt_box" style="float:right">
                                <a href="#" onclick="pageSort('name','asc')"><img src="../images/jt_2.gif" width="16"
                                                                                  height="16" title="排序字段"/></a>
                            </div>
                        </td>
                    </c:if>
                    ...
                    <c:if test="${orderbyColum eq 'type'}">
                        <td class="list_table_top_td">
                            ...
                            <div class="jt_box" style="float:right">
                                <c:if test="${orderbyMethod eq 'desc'}">
                                    <a href="#" onclick="pageSort('type','asc')"><img src="../images/jt_2.gif"
                                                                                      width="16" height="16"
                                                                                      title="排序字段"/></a>
                                </c:if>
                                <c:if test="${orderbyMethod ne 'desc'}">
                                    <a href="#" onclick="pageSort('type','desc')"><img src="../images/jt_1.gif"
                                                                                       width="16" height="16"
                                                                                       title="排序字段"/></a>
                                </c:if>
                            </div>
                    ...
                    <c:if test="${orderbyColum ne 'type'}">
                        <td class="list_table_top_td">
                            <div style="float:left">操作类型</div>
                            <div class="jt_box" style="float:right">
                                <a href="#" onclick="pageSort('type','asc')"><img src="../images/jt_2.gif" width="16"
                                                                                  height="16" title="排序字段"/></a>
                            </div>
                        </td>
                    </c:if>
                    ...
                    <c:if test="${orderbyColum eq 'date'}">
                        <td class="list_table_top_td">
                            ...
                            <div class="jt_box" style="float:right">
                                <c:if test="${orderbyMethod eq 'desc'}">
                                    <a href="#" onclick="pageSort('date','asc')"><img src="../images/jt_2.gif"
                                                                                      width="16" height="16"
                                                                                      title="排序字段"/></a>
                                </c:if>
                                <c:if test="${orderbyMethod ne 'desc'}">
                                    <a href="#" onclick="pageSort('date','desc')"><img src="../images/jt_1.gif"
                                                                                       width="16" height="16"
                                                                                       title="排序字段"/></a>
                                </c:if>
                            </div>
                    ...
                    <c:if test="${orderbyColum ne 'date'}">
                        <td class="list_table_top_td">
                            <div style="float:left">操作日期</div>
                            <div class="jt_box" style="float:right">
                                <a href="#" onclick="pageSort('date','asc')"><img src="../images/jt_2.gif" width="16"
                                                                                  height="16" title="排序字段"/></a>
                            </div>
                        </td>
                    </c:if>
