...
userid = sysuser.getUserId().toString();
    ...
    List<UserLogin_log> list = userLogin_logBo.findPageByUserList(userid,searchField, searchValue, userLoginValue, startDate, endDate, orderbyColum, orderbyMethod, pageSize, pageNo, pageComponent);
...
<body>
<div class="page_top">系统 &gt;&gt; 日志查询 &gt;&gt; 用户登录日志</div>
<div id="list_main">
