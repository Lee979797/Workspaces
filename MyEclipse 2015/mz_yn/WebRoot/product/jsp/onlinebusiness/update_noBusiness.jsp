...
//            }
        ...
        function back() {
            ...
            window.location.href = '/bsweb/onLine_jdList.action?ywlx=2&opt=wsywjd&zt=3';
            </c:if>
...
<body>
<form method="post" action="/bsweb/onlineBus_${needAudit==true?"auditUpdate_no":"update_no"}.action" name="busForm"
      id="busForm">
    ...
    <input type="hidden" name="ywlx" value="${ywlx}" id="ywlx" />
    <input type="hidden" name="djh" value="${djh}" id="djh" />


    <div class="page_top_fixed">
        <div align="left" style=" float: left;">审核 &gt;&gt; 网上业务 &gt;&gt; 代码变更</div>
