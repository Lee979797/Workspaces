...
<form name="searchForm" method="post" action="/bsweb/preScan_frontScanList">
    <div class="list_box">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr class="list_table_top">
                ...
                <td class="list_table_top_td" align="center">状态
                </td>
                <td class="list_table_top_td" align="center">设置扫描
                </td>
            ...
            <tr ${(i.count % 2 eq 1)?"class='list_tr'":"class='list_tr2'" }>
                ...
                <td>&nbsp;${cf.xzqh }</td>
                <td>&nbsp;${cf.mc }</td>
                <td align="center">&nbsp;${scanMap[fn:trim(cf.xzqh)]=='0'?'关闭':'<font color=red>开启</font>'}</td>
                <td align="center">
