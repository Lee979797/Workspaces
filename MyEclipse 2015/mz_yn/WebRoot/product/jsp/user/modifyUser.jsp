...
<!-- lvwei 发证机关修改  2017-07-21   start-->
        <td width="15%" class="table1_td1" nowrap>发证机关<span style="color: #FF0000">(*)</span>：</td>
        <td ><input type="text" name="printName" maxlength="30" size="30" isnull="false"
                   class="page_input2"
                   value="${fn:trim(user.printName)}">
        </td>
<!-- lvwei 发证机关修改  2017-07-21   end-->
