 ...
 * @author yanzh
 */
public class ICCardOptAction extends ActionSupport implements SessionAware {
    private static final String path = "/product/jsp/ICCard/";
    ...
    public String check() {
        return new ActionUtils(session) {
            ...
            protected void excute() throws Exception {
                ...
                em.createNativeQuery(strSql).executeUpdate();
                message = "机构代码(" + jgdm.getJgdm() + ")流水号为(" + strLsh + ")的IC卡年检完毕！";
    ...
    public String punchICCard() {
        return new ActionUtils(session) {
            ...
            protected void excute() throws Exception {
                ...
                em.persist(czjl);
                setTitle("IC卡 &gt;&gt; IC卡操作 &gt;&gt; 制卡");
                message = "机构代码(" + jgdm.getJgdm() + ")流水号为(" + kxxk.getLsh() + ")的IC卡制卡完毕！";
                currentPath = path + "success.jsp";
            }
        }.template();
    ...
    public String checkICCard() {
        return new ActionUtils(session) {
            ...
            protected void excute() throws Exception {
                ...
                czjl.setKlsh(kxxk.getLsh().longValue());
                em.persist(czjl);
                message = "机构代码(" + jgdm.getJgdm() + ")流水号为(" + kxxk.getLsh() + ")的IC卡年检完毕！";
                source = "check";
                currentPath = path + "success.jsp";
            }
        }.template();
    ...
    public String updateICCard() {
        return new ActionUtils(session) {
            ...
            protected void excute() throws Exception {
                ...
                source = "update";
                currentPath = path + "success.jsp";
                message = "机构代码(" + jgdm.getJgdm() + ")序列号为(" + kxxk.getKxlh() + ")的IC卡变更完毕！";
    ...
    public String validateICCard() {
        return new ActionUtils(session) {
            ...
            protected void excute() throws Exception {
                ...
                query.executeUpdate();
                source = "validate";
                message = "机构代码(" + jgdm.getJgdm() + ")IC卡注销成功！";
                currentPath = path + "success.jsp";
            }
        }.template();
    }
        ...
        return new ActionUtils(session) {
            ...
            protected void excute() throws Exception {
                ...
                if (kxxks == null || kxxks.isEmpty()) {
                    ...
                    em.createQuery(sql).executeUpdate();
                    message = "为机构代码(" + jgdm.getJgdm() + ")退发了申请要发的IC卡！";
                    source = "back";
                    currentPath = path + "success.jsp";
