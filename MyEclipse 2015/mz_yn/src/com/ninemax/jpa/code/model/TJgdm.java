...
public class TJgdm  implements java.io.Serializable {
   ...
   //xiaruibo 20170220 增加三个属性 脱钩 慈善 募捐
 	...
 	//xiaruibo 20170620  疑似问题数据
 	 private String yswtsj;
 	 
 	 //xiaruibo 20170620    导入excel数据时，最后一次导入时间
 	 private Date lastdrsj;
...
//    }
    ...
    @Column(name="fddbr",columnDefinition="nvarchar(400)")
...
//		if(fddbr!=null && !"".equals(fddbr.trim())){
...
//    }
    ...
    @Column(name="jgdz",columnDefinition="nvarchar(240)")
    public String getJgdz() {
        return this.jgdz;
    }
    
//    public void setJgdz(String jgdz) {
//    	if(jgdz != null && !"".equals(jgdz.trim())){
...
//    }
	...
	@Column(name="lastdrsj", length=23)
	public Date getLastdrsj() {
		return lastdrsj;
	}
	public void setLastdrsj(Date lastdrsj) {
		this.lastdrsj = lastdrsj;
	}
	@Column(name="yswtsj")
	public String getYswtsj() {
		return yswtsj;
	}
	public void setYswtsj(String yswtsj) {
		this.yswtsj = yswtsj;
	}
