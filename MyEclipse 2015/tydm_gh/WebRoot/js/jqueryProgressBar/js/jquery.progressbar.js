	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: '/js/jqueryProgressBar/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage	: {
								0:	'/js/jqueryProgressBar/images/progressbg_red.gif',
								30: '/js/jqueryProgressBar/images/progressbg_orange.gif',
								70: '/js/jqueryProgressBar/images/progressbg_green.gif'
							},												// Image to use in the progressbar. Can be a single image too: '/js/jqueryProgressBar/images/progressbg_green.gif'
