...
<head>
    ...
    <script language="javascript" src="/js/LodopFuncs.js?v=2013.3.4.1"></script>
...
<div class="page_top">
    ...
    <div align="right" style=" float: right;" id="print">
...
<object id="LODOP_OB" classid="clsid:2105C259-1E0C-4534-8141-A753534CB4CA"
        width="100%" height="600" style="height:1196px; margin-top: 15px">
