    ...
    <div class="prompti">
        ...
        <div class="prompt_right">
            <ul>
                ...
                <li>
                      <c:if test="${nameType ne 'revisionForbidden'}">
                        <input type="submit" name="modify" value="校对赋码"
                               onClick="window.location.href='/bsweb/certificate_viewPage.action?id=${id}&type=2&formType=${formType}&path=page&nav=${formType eq '4'?'0':'1'}'"
                               class="newBtn1" />
            		 </c:if>
