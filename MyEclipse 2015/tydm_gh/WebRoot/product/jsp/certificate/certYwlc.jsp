...
function checkCode(jgdm){
    window.location.href="/bsweb/certificate_search.action?jgdm="+jgdm+"&source=certChange&bzjgdm=${fn:trim(sysUser.bzjgdm)}&pageno=${pageno}&rowNumsView=${rowNumsView}";
}
</script>
</head>
<body>
<div class="page_top">发证 &gt;&gt; 换证管理 &gt;&gt; 换证处理</div>
    ...
    <div class="list_box_top">
     ...
     <table width="100%" border="0" cellpadding="0" cellspacing="0">
      	<tr class="list_table_top">
            ...
            <td class="list_table_top_td" align="center">换证</td>
      	</tr>
      	<c:forEach varStatus="i" var="ywlc" items="${ywlcList}">
      		<tr ${i.count % 2==1?"class='list_tr'":"class='list_tr2'" }>
                ...
                <td align="center"><img src="../../images/icon_edit.gif" width="16" height="16" onclick="checkCode('${ywlc.jgdm}');" style="cursor:pointer" title="换证"/></td>
      		</tr>
      	</c:forEach>
    </table>
  </div>
