...
<body>
<div class="page_top">发证 &gt;&gt; 申请表删除 &gt;&gt; 申请表删除</div>
<form  name="searchForm" method="post" action="/bsweb/certificate_delApplySaveList.action">
    ...
    <div class="list_box_top">
     ...
     <table width="100%" border="0" cellpadding="0" cellspacing="0">
      	<tr class="list_table_top">
            ...
            <c:if test="${needAudit}">
              <td class="list_table_top_td"><div style="float:left">审核状态</div></td>
      	...
      	<c:forEach varStatus="i" var="ywlc" items="${ywlcDelList}">
      		<tr ${i.count % 2==1?"class='list_tr'":"class='list_tr2'" }>
                ...
                <c:if test="${ywlc.flag=='0'}">
                    <td>已提交审核</td>
                    <td align="center"><img src="../../images/icon_chakan.gif" width="16" height="16" onclick="window.location.href='/bsweb/certificate_viewPage.action?jgdm=${ywlc.jgdm}&type=1&formType=4&delFlag=0&pageno=${pageno}&rowNumsView=${rowNumsView}'" style="cursor:pointer" title="查看"/></td>
                </c:if>
                <c:if test="${ywlc.flag=='1' and fn:trim(ywlc.shflag)=='1'}">
                    <td>审核通过</td>
                    <td align="center"><img src="../../images/icon_del.gif" width="16" height="16" onclick="window.location.href='/bsweb/certificate_viewPage.action?jgdm=${ywlc.jgdm}&type=1&formType=4&delFlag=1&pageno=${pageno}&rowNumsView=${rowNumsView}'" style="cursor:pointer" title="删除"/></td>
                </c:if>
                <c:if test="${ywlc.flag=='1' and fn:trim(ywlc.shflag)=='0'}">
                    <td>已审核,不允许删除</td>
                    <td align="center"><img src="../../images/report_go.png" width="16" height="16" onclick="window.location.href='/bsweb/certificate_viewPage.action?jgdm=${ywlc.jgdm}&type=1&formType=4&delFlag=3&pageno=${pageno}&rowNumsView=${rowNumsView}'" style="cursor:pointer" title="重新提交审核"/></td>
                </c:if>
                <c:if test="${ywlc.flag=='2'}">
                    <td>需要审核</td>
                    <td align="center"><img src="../../images/report_go.png" width="16" height="16" onclick="window.location.href='/bsweb/certificate_viewPage.action?jgdm=${ywlc.jgdm}&type=1&formType=4&delFlag=2&pageno=${pageno}&rowNumsView=${rowNumsView}'" style="cursor:pointer" title="提交审核"/></td>
                </c:if>
                <c:if test="${!needAudit}">
                    <td align="center"><img src="../../images/icon_del.gif" width="16" height="16" onclick="window.location.href='/bsweb/certificate_viewPage.action?jgdm=${ywlc.jgdm}&type=1&formType=4&pageno=${pageno}&rowNumsView=${rowNumsView}'" style="cursor:pointer" title="删除"/></td>
                </c:if>
      		</tr>
      	</c:forEach>
    </table>
