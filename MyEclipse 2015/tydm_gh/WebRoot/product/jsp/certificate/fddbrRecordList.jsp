...
<div class="page_top">登记 &gt;&gt;工会业务&gt;&gt;  法定代表人查询</div>
<form name="searchForm" method="post" action="/bsweb/business_fddbrRecordList.action">
    ...
    <div id="list_main">
        <div class="list_box">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <c:forEach varStatus="i" var="list" items="${listFddbr}">
                    <tr ${i.count % 2==1?"class='list_tr'":"class='list_tr2'" }>
                        ...
                        <td>${list.xm}</td>
                        <td>${list.zjhm }</td>
                        <td align="center"><a href="/bsweb/business_showFddbrSearch?fddbr.lsh=${list.lsh }"><img src="/product/images/icon_chakan.gif" width="16" height="16"
