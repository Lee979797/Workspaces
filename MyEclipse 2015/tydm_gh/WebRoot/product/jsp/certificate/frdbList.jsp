...
<body>
<div class="page_top" style="text-align:center;font-weight:bold;"><c:if test="${'fddbr' eq path}">法人代表</c:if><c:if test="${'zjhm' eq path}">法人代表证件号码</c:if>重名检测情况</div>
<div id="list_main">
  <div class="list_box">
     <table width="100%" border="0" cellpadding="0" cellspacing="0">
      	...
      	<c:forEach varStatus="i" var="tjgdmsave" items="${commonList}">
      		<tr ${i.count % 2==1?"class='list_tr'":"class='list_tr2'" }>
                <td>${fn:trim(tjgdmsave.tyshxydm) eq ""?"无":tjgdmsave.tyshxydm }</td>
