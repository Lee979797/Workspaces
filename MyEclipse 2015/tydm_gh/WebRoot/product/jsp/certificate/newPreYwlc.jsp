...
<body>
<div class="page_top">发证 &gt;&gt; 申请表登记 &gt;&gt; 预赋码颁证</div>
      	...
      	<c:forEach varStatus="i" var="ywlc" items="${ywlcList}">
      		<tr ${i.count % 2==1?"class='list_tr'":"class='list_tr2'" }>
                ...
                <%--<td align="center"><img src="../../images/application_form_edit.png" width="16" height="16"
                         onclick="window.location.href='/bsweb/certificate_updateRequisitionPage.action?id=${fn:trim(ywlc.jgdm)}&formType=${formType}&pageno=${pageno}&rowNumsView=${rowNumsView}'"
                         style="cursor:pointer;" title="通知修改"/></td>--%>
                <td align="center"><img src="../../images/icon_edit.gif" width="16" height="16"
                         onclick="window.location.href='/bsweb/certificate_updatePage.action?ywlsh=${ywlc.ywlsh}&id=${fn:trim(ywlc.jgdm)}&formType=${formType}&pageno=${pageno}&rowNumsView=${rowNumsView}'"
                ...
                <td align="center"><img src="../../images/gonggaogl.png" width="16" height="16"
                         onclick="window.location.href='/bsweb/certificate_viewPage.action?ywlsh=${ywlc.ywlsh}&id=${fn:trim(ywlc.jgdm)}&type=2&formType=${formType}&pageno=${pageno}&rowNumsView=${rowNumsView}&nav=1'"
                         style="cursor:pointer;" title="校对"/></td>
                  </c:if>
                <%--<td align="center"><a href="/bsweb/certificate_printCertNotice.action?id=${fn:trim(ywlc.jgdm)}&pageno=${pageno}&rowNumsView=${rowNumsView}">
                    <img src="../../images/print_16x16.gif" width="16" height="16"
                         style="cursor:pointer;" title="打印"/></a></td>
