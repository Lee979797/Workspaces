...
<body>
<div class="page_top">发证 &gt;&gt; 申请表登记 &gt;&gt; <%=title%></div>
...
<div id="list_main">
  <div class="list_box">
    <div class="list_box_top">
        ...
        <input name="button2" type="button" class="newBtn1" value="新 增" onclick="window.location.href='/product/jsp/certificate/addinfomationEnter.jsp?formType=<%=formType%>'"/>
    </div>
     <table width="100%" border="0" cellpadding="0" cellspacing="0">
      	<tr class="list_table_top">
            ...
            <td class="list_table_top_td" align="center">修改</td>
              ...
              <c:if test="${zrxzqhs[sysUser.bzjgdm].fmflag}">
            <td class="list_table_top_td" align="center">校对赋码</td>
              </c:if>
      	...
      	<c:forEach varStatus="i" var="ywlc" items="${ywlcList}">
      		<tr ${i.count % 2==1?"class='list_tr'":"class='list_tr2'" }>
                ...
                <td align="center"><img src="../../images/icon_edit.gif" width="16" height="16" onclick="window.location.href='/bsweb/certificate_updatePage.action?ywlsh=${ywlc.ywlsh}&id=${fn:trim(ywlc.jgdm)}&formType=${formType}&pageno=${pageno}&rowNumsView=${rowNumsView}&nav=1'" style="cursor:pointer" title="修改"/></td>
      			<c:if test="${formType eq 0}">
                <td align="center"><img src="../../images/icon_del.gif" width="16" height="16" onclick="window.location.href='/bsweb/certificate_viewPage.action?id=${fn:trim(ywlc.jgdm)}&type=1&formType=${formType}&pageno=${pageno}&rowNumsView=${rowNumsView}&nav=1'" style="cursor:pointer" title="删除"/></td>
                </c:if>
                  <c:if test="${zrxzqhs[sysUser.bzjgdm].fmflag}">
                <td align="center"><img src="../../images/gonggaogl.png" width="16" height="16" onclick="window.location.href='/bsweb/certificate_viewPage.action?id=${fn:trim(ywlc.jgdm)}&type=2&formType=${formType}&pageno=${pageno}&rowNumsView=${rowNumsView}&nav=1'" style="cursor:pointer" title="校对"/></td>
                  </c:if>
                  <td align="center"><img src="../../images/icon_chakan.gif" width="16" height="16" onclick="window.location.href='/bsweb/certificate_viewPage.action?id=${fn:trim(ywlc.jgdm)}&type=3&formType=${formType}&pageno=${pageno}&rowNumsView=${rowNumsView}&nav=1'" style="cursor:pointer" title="查看"/></td>
      		</tr>
      	</c:forEach>
    </table>
  </div>
