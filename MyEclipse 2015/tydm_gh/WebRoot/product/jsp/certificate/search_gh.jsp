...
<head>
    ...
    function fCheckValue() {
        var jgdm = document.getElementById("jgmc");
        if (jgdm.value=='') {
            ymPrompt.alert({message:"请输入名称", width:330, height:220, handler:function () {
                jgdm.focus();
            }});
...
<div id="list_main">
    <form method="POST" name='thisForm' action="/bsweb/certificate_searchDm.action">
        ...
        <div class="list_box">
            <div class="list_box_top" style="text-align: center;">
                   名称：
                <input type="text" name="jgdmdm.jgmc" size="21" id="jgmc"
                       maxlength="18" value="${jgdmdm.jgmc}" class="input_200"
