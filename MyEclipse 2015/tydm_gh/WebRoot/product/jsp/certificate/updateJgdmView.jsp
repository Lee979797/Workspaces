...
<head><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7"/>
    ...
    <script type="text/javascript">
        function certChange() {
            window.location.href = '/bsweb/certificate_updateJgdm.action?tyshxydm=${tjgdm.tyshxydm}&formType=${formType}&audit=${audit}&needAudit=${needAudit}';
        }
    </script>
</head>
<body>
<div class="page_top_fixed">
    <div style=" float: left;"> 发证 &gt;&gt; 申请表修改 &gt;&gt; 申请表修改
    </div>
    <div align="right" style="width: 30% ; float: right;">
        <INPUT class="newBtn1" onClick="javascript:return certChange();" type=button value="修 改" name="btok" />&nbsp;
