    ...
    <td class=td1 align=right width="15%">
     ...
     <td class=td1 colspan="3" >
        <INPUT onkeyup="onlyMc(this);"
                ...
                maxLength=120 size=28 name="jgdm.tyshxydm" id="tyshxydm" style ="background-color:lightGray" style="width:75%;" readonly = "readonly"
                value="${jgdm.tyshxydm}"/>
                <!--  <FONT color=red> * </FONT>
...
<TR>
    ...
    <td class=td1 align=right width="15%">
     ...
     <td class=td1 colspan="3" >
        <INPUT onkeyup="onlyMc(this);"
                onblur="this.className='input_off';trimIntputValue(this);return judgeCodeName();"
                maxLength=120 size=28 name="jgdm.jgmc" id="jgmc" style ="background-color:lightGray;"  readonly = "readonly" 
                value="${jgdm.jgmc}"/>
                <!--  <FONT color=red> * </FONT>
                  <span style="color:red;" id="mcInfo"></span> -->
    </td>
...
<div class="listbtn">
    <INPUT class="newBtn1"  type=submit value="保 存" name="btok"/>&nbsp;<INPUT
        class="newBtn1"
