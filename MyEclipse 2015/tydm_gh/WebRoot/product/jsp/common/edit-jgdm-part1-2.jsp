...
<TR>
    ...
    <TD class="td1" >
        <input name="jgdm.jglx" id="jglx" type="hidden" value="${fn:trim(jgdm.jglx)}">
    ...
    <TD class="td1" >
        <SELECT name="jgdm.njglx" id="njglx" style=" width:200px;">
...
<TR>
    ...
    <TD class="td1">
        ...
        ${(jgdm.fkbz eq null or "0"==jgdm.fkbz)?"checked":""} value="0" name="jgdm.fkbz"/>
        暂不发卡
        <INPUT onclick="fChangeRadioForFlag(1);" type="radio"  ${"1"==jgdm.fkbz?"checked":""} value="1"
               name="jgdm.fkbz"/>
        发卡&nbsp;
        <span id="fkslmc" style="display:  ${"1"==jgdm.fkbz?"inline":"none"};">发卡数量：
        <INPUT onkeyup="onlyDecimal(this);" onafterpaste="onlyDecimal(this);;"
                 maxLength="2" size="2"
               value="${jgdm.fksl}" name="jgdm.fksl" id="fksl"/>
        </span>
    </TD>
    <TD class="td1" align="right" width="15%">&nbsp;
    </TD>
    <TD class="td1" >
        ...
        <INPUT style="width:20px;BACKGROUND-COLOR: #e0e0e0;"
               ...
               value="${jgdm.fbsl eq null ?1:jgdm.fbsl}" name="jgdm.fbsl" id="fbsl"/>
    </TD>
</TR>
<TR>
    <TD class="td1" align="right">
    ...
    <TD class="td1" style="position:relative;display:block;overflow:visible;">
        ...
        <INPUT  onblur="this.className='input_off';"
               ...
               name="jgdm.zch" id="zch" ${(audit &&!needAudit)?'readOnly':''} value="${jgdm.zch}"
               style=" width:200px;"/>
               <a href="#" style="text-decoration:underline;color:#0000ff;" onclick="hqGssj();">获取工商数据</a>
    ...
    <TD class="td1">
        <INPUT type="radio"  ${(jgdm.gk eq null or "1"==jgdm.gk)?"checked":""} value="1" name="jgdm.gk"/>
        是
        <INPUT type="radio" ${"2"==jgdm.gk?"checked":""} value="2" name="jgdm.gk"/>
        否
    </TD>
</TR>
<TR>
    ...
    <TD class="td1" style="position:relative;display:block;overflow:visible;">
        <INPUT name="jgdm.jgmc" id="jgmc" value="${jgdm.jgmc}"
...
<TR>
    ...
    <TD class="td1" style="position:relative;display:block;overflow:visible;">
        <INPUT  onblur="this.className='input_off';return judgeFddbrZjh();"
               onpaste="return onCharsChange_sfzh(this);" onkeyup="return onCharsChange_sfzh(this);" name="jgdm.zjhm"
...
<TR>
    ...
    <TD class="td1" style="position:relative;display:block;overflow:visible;">
        <INPUT value="${fn:trim(jgdm.xzqh)}" name="jgdm.xzqh" id="xzqh"
...
<TR>
    ...
    <TD class="td1" colSpan="3">
        <INPUT size="158" name="jgdm.jgdz" id="jgdz" value="${jgdm.jgdz}" readonly="readonly"
...
<TR>
    ...
    <TD class="td1" style="position:relative;display:block;overflow:visible;">
        <INPUT   maxLength="6" size="23"
               name="jgdm.nnjjhy" id="nnjjhy" value="${fn:trim(jgdm.nnjjhy)}"
    ...
    <TD class="td1" style="position:relative;display:block;overflow:visible;">
        <INPUT   maxLength="5" id="njjhy"
               name="jgdm.njjhy" style="z-index: 100; position: relative; width:200px;" value="${fn:trim(jgdm.njjhy)}"/>
...
<TR>
    ...
    <TD class="td1">
        <INPUT onfocus="this.className='input_on';WdatePicker({el:$dp.$('njqx')});"
               maxLength="10" size="23"
               name="jgdm.njqx" id="njqx" value="<fmt:formatDate value='${jgdm.njqx}' pattern='yyyy-MM-dd'/>"
    ...
    <TD class="td1">
        <INPUT readonly="readonly"
               name="jgdm.zfrq" id="zfrq" value="<fmt:formatDate value='${jgdm.zfrq}' pattern="yyyy-MM-dd" />"
               style="BACKGROUND-COLOR: #e0e0e0; width:200px;"/>
    </TD>
</TR>
<TR>
...
<TR>
    ...
    <TD class="td1" style="position:relative;display:block;overflow:visible;">
        <INPUT maxLength="25" size="19" name="jgdm.dhhm" id="dhhm" value="${jgdm.dhhm}" style=" width:200px;"/>
...
<TR>
    ...
    <TD class="td1">
        <INPUT onkeyup="rightValues(this);" onafterpaste="rightValues(this);"
                 maxLength="9" size="23"
               name="jgdm.pzjgdm" id="pzjgdm" style="z-index: 100; position: relative; width:200px;"
    ...
    <td class="td1">
        <input name="jgdm.pzjgmc" id="pzjgmc1" type="hidden" value="${jgdm.pzjgmc}">
