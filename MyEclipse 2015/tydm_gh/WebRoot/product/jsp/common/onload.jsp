...
<div id="lizi" style="display:none;"> 
	...
	<input type="hidden" name="fzr.id" value=""/>
		<tr>
			...
			<td class=td1>
				<input type="text" class="fzrxm" name="fzr.xm" maxlength="50" >
		...
		<td class=td1 align=right>
			...
			<td class=td1>
				<input type="text" name="fzr.memo1" onfocus="this.className='input_on';WdatePicker({el:$dp.$(this)});" onclick="WdatePicker({el:$dp.$(this)});" style="BACKGROUND-COLOR: #e0e0e0;"  readonly="true">
				<span style="color:red">*</span>
			</td>
				<td class=td1 align=right>
				政治面貌
			...
			<td class=td1>
				<input type="text" name="fzr.dzdw" maxlength="200" >
			</td>
			<td class=td1 align=right>
				专职/兼职
			</td>
			...
			<td class=td1>
				<input type="text" name="fzr.lxdh" onpaste="showDhLength();" onkeyup="onlyDecimalTel(this);showDhLength();" maxlength="25" >
			...
			<td class=td1>
				<input type="text" name="fzr.lxmobile" onkeyup="onlyDecimalTel(this);showMobileLength();" onafterpaste="onlyDecimalZero(this);showMobileLength();" maxlength="11" >
	...
	<tr>
		...
		<tr>
			<td align="right" colspan="4">			<INPUT class="newBtn1" onClick="deletelingjian(this)" type=button value="移  除" name="btok"/></td>
		</tr>
