                            ...
                            <tr class="table1_tr1">
                                    ...
                                    <c:when test="${table eq 'sc_bzjgdm'}">
                                      ...
                                      <td class="table1_td1" align="right">级别：</td>
		                                ...
		                                <option value="0" ${bzjgObj.depth eq '1'?'selected':'' }>0</option>
		                                <option value="1" ${bzjgObj.depth eq '2'?'selected':'' }>1</option>
		                                <option value="2" ${bzjgObj.depth eq '3'?'selected':'' }>2</option>
		                                </select>
									 </td>
