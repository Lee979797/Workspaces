...
<div id="list_main">
 ...
 --%>
                    ...
                    <td class="list_table_top_td" style="width:8%">
                            ...
                            <div class="jt_box" style="float:right">
                                <a href="#"
                                   onclick="Page.sort('lry','${(page.orderByField eq 'lry' and page.orderByType eq 'asc')?'desc':'asc'}')">
                                    <img src="../images/${(page.orderByField eq 'lry' and page.orderByType eq 'asc')?'jt_1':'jt_2'}.gif"
                                         width="16" height="16" title="排序字段"/></a>
                            </div>
                    </td>
                        </c:if>
                    ...
                    <tr ${(i.count % 2 eq 1)?"class='list_tr'":"class='list_tr2'" }>
                        ...
                        <td>
                            <%-- <fmt:formatDate value="${source ne 'unvalidate'?dm.bzrq:dm.fzrq}"/> --%>
                             <fmt:formatDate value="${source ne 'unvalidate'?dm.bzrq:dm.lastdate}"/>
                        </td>
                        <td align="center">
