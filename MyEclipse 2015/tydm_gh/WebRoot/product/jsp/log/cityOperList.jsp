...
<head>
    ...
    <script type="text/javascript">
        ...
        function cityExportData() {
            window.location.href = "/bsweb/log_cityExport.action";
        }
    </script>
</head>
<body>
<div class="page_top">系统 &gt;&gt; 日志查询 &gt;&gt; 市级用户操作日志</div>
<form name="searchForm" method="post" action="/bsweb/log_cityOperList.action">
    ...
    <div id="list_main">
        <div class="list_box">
            <div class="list_box_top">
              ...
              <%--  <input name="exportBtn" type="button" class="newBtn1" id="exportBtn" value="导 出"
                       onclick="cityExportData();"/>--%>
            </div>
