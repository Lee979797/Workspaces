...
<%@ page import="com.ninemax.jpa.system.bo.SysManage_logBo" %>
<%@ page import="com.ninemax.jpa.system.model.SysManage_log" %>
...
<%
    ...
    if (clsStringTool.isEmpty(searchField)) searchField = "userid";
    ...
    List<SysManage_log> list = sysManage_logBo.findPageList(searchField, searchValue, startDate, endDate, orderbyColum, orderbyMethod, pageSize, pageNo, pageComponent);
...
<body>
<div class="page_top">系统 &gt;&gt; 日志查询 &gt;&gt; 系统管理日志</div>
<div id="list_main">
...
<div class="list_box_top">
    <input name="textfield2" type="text" class="input_120" id="textfield" style="display:none"/>

    <label for="searchField"> 用户名：</label>
    ...
    开始日期：
    <label>
        <input id="CalendarSelector1" readOnly name="startDate" type="text" value="<%=startDate%>" class="input_120"
               onfocus="WdatePicker({el:'CalendarSelector1'})"/><IMG src="../images/icon_day.gif"
                                                                     style="cursor:pointer;" align=absMiddle
                                                                     onClick="WdatePicker({el:'CalendarSelector1'})"/>
    </label>
    结束日期：
    <label>
        <input id="CalendarSelector2" readOnly name="endDate" value="<%=endDate%>" type="text" class="input_120"
               onfocus="WdatePicker({el:'CalendarSelector2'})"/><IMG src="../images/icon_day.gif"
                                                                     style="cursor:pointer;" align=absMiddle
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr class="list_table_top">
        ...
        <td class="list_table_top_td">
            <div style="float:left">操作用户</div>
            <div class="jt_box" style="float:right">
                <%
        	if(orderbyMethod.equals("desc")){
        %><!--排序字段是否降序排序-->
                <a href="#" onclick="pageSort('username','asc')"><img src="../images/jt_2.gif" width="16" height="16"
                                                                      title="排序字段"/></a>
                <%
                } else {
                %>
                <a href="#" onclick="pageSort('username','desc')"><img src="../images/jt_1.gif" width="16" height="16"
                                                                       title="排序字段"/></a>
                <%
                    }
                %>
        ...
        <%
            if (orderbyColum.equals("memo")) {
        %>
        <td class="list_table_top_td">
            <div style="float:left">操作功能</div>
            <div class="jt_box" style="float:right">
                <%
        	if(orderbyMethod.equals("desc")){
        %><!--排序字段是否降序排序-->
                <a href="#" onclick="pageSort('memo','asc')"><img src="../images/jt_2.gif" width="16" height="16"
                                                                  title="排序字段"/></a>
                <%
                } else {
                %>
                <a href="#" onclick="pageSort('memo','desc')"><img src="../images/jt_1.gif" width="16" height="16"
                                                                   title="排序字段"/></a>
                <%
                    }
                %>
        ...
        <%
            if (orderbyColum.equals("opervalue")) {
        %>
        <td class="list_table_top_td">
            <div style="float:left">操作描述</div>
            <div class="jt_box" style="float:right">
                <%
        	if(orderbyMethod.equals("desc")){
        %><!--排序字段是否降序排序-->
                <a href="#" onclick="pageSort('opervalue','asc')"><img src="../images/jt_2.gif" width="16" height="16"
                                                                       title="排序字段"/></a>
                <%
                } else {
                %>
                <a href="#" onclick="pageSort('opervalue','desc')"><img src="../images/jt_1.gif" width="16" height="16"
                                                                        title="排序字段"/></a>
                <%
                    }
                %>
        ...
        %>
        <td class="list_table_top_td">
            <div style="float:left">操作时间</div>
            <div class="jt_box" style="float:right">
                <%
        	if(orderbyMethod.equals("desc")){
        %><!--排序字段是否降序排序-->
                <a href="#" onclick="pageSort('operdate','asc')"><img src="../images/jt_2.gif" width="16" height="16"
                                                                      title="排序字段"/></a>
                <%
                } else {
                %>
                <a href="#" onclick="pageSort('operdate','desc')"><img src="../images/jt_1.gif" width="16" height="16"
                                                                       title="排序字段"/></a>
                <%
                    }
                %>
    ...
    <%
        ...
        for (SysManage_log u : list) {
            ...
            String chineseName = "";
            if (user != null) {
                chineseName = user.getUserChinesename();// user.getUserChinesename();
            }
            //权限
    ...
    <tr class="list_tr2">
        ...
        <td><%=DateUtil.dateToStr(u.getOperdate(),"yyyy-MM-dd HH:mm:ss") %>
        </td>
