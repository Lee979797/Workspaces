...
<head>
    ...
    <script type="text/javascript">
        ...
        function back() {
            window.location.href = '/bsweb/onLine_jdList.action?ywlx=6&opt=wsywjd&zt=3';
        }
    </script>
</head>
<body>
<div class="page_top_fixed">
    <div align="left" style=" float: left;"><strong>审核 &gt;&gt; 网上业务 &gt;&gt; 代码注销</strong></div>
...
<form method="post" action="/bsweb/onlineBus_${needAudit==true?"auditValidate":"validateDM"}.action" name="busForm"
      id="busForm">
            ...
            <div id="right">
                <div class="rightpart">
                    <div class="list listblue">
                        <h3><b>代码注销</b></h3>
                        <table class=tableBorder0llPadding=5 align=center border=0 width="100%"
                               bgcolor="#eaf6fb">
                            <c:if test="${audit}">
                                <tr>
