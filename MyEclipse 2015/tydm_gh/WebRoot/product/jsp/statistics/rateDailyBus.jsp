    ...
    <c:if test="${! empty models}">
        <script type="text/javascript">
            ...
            function makeGastaxDataVortex() {
                ...
                gastaxDataVortex.setValue(metricAccounts, '${model.rate1}${model.rate1 eq 0?'':'%'}', [tp, zone]);
                </c:forEach>
...
<div id="list_main">
    <form name="searchForm" method="post" action="/bsweb/statistics_rateDailyBus.action">
