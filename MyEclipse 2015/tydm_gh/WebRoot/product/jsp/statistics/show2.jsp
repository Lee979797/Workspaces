...
<head>
    ...
    <script type="text/javascript" >
	  ...
	  #table {
    	...
    	#unreport{float: center;overflow:auto;padding-top:10px;}
     ...
     <div id="centerbox">
  	<div id="layout1">
	   ...
	   <object
		  ...
		  id="scanner" 
		  name="scanner"
		  style="position:absolute;right:0px;top:0px;z-index:1;"
	  	>
		<param name="ShowCount" value="8" />
		<param name="sModel" value="2" /> <!-- "1"代表按钮可以编辑，"2"代表按钮不能编辑 -->
