    ...
    public String searchBy(){
    	 return new ActionUtils() {
             ...
             protected void excute() throws Exception {
            	 ...
            	 List<Object[]> jgdmList = em.createQuery(" select model.jgmc,model.bzjgdm from TJgdm model where model.tyshxydm = '"+tydm+"'").getResultList();
            	 if(jgdmList.size() == 0){
...
//lvwei 2018-01-16 机构迁址增加数据权限    
            	...
            	if(user_bzjgdm.substring(1).equals("00000")){
            		 for(Object[] obj : jgdmList){	 
            		 	...
            		 	currentPath = path + "upBzjgdm.jsp";
            	//省级账号
            	}else if(user_bzjgdm.substring(2).equals("0000")){
            		for(Object[] obj : jgdmList){	 
       				 	if(!user_bzjgdm.substring(0,1).equals((String)obj[1].toString().substring(0,1))){
            	...
            	//市级账号
            		...
            		for(Object[] obj : jgdmList){	 
       				 	if(!user_bzjgdm.substring(0,3).equals((String)obj[1].toString().substring(0,3))){
       					 setMessage("当前账号无权进行此机构的迁址");
                   		 currentPath = path + "search.jsp";
                   		 return; 
       				 	}
    ...
    public String upBzjgdm(){
    	...
    	return new ActionUtils() {
            ...
            protected void excute() throws Exception {
           	 ...
           	 String sql = "update TJgdm model set model.bzjgdm = '"+jgdm.getBzjgdm()+"'where tyshxydm ='"+jgdm.getTyshxydm()+"'" ;
