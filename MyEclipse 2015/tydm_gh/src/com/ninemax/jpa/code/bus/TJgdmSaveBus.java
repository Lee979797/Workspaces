...
public class TJgdmSaveBus {
    ...
    public int AddTjgdmSave(TJgdmSave jgdmSave) {
    	...
    	if (dao.save(jgdmSave)) {
            //TODO     CheckEntityManagerHelper.getEntityManager().createNativeQuery(" " + tableName + " set state='1' " + " where " + idName + "='" + jgdmSave.getBak5() + "'").executeUpdate();
            return 1;
        } else
            return 0;
    }
    
    public int AddTjgdmSave(TJgdmSave jgdmSave,TFddbr fddbr,TFrjl frjl) {
    	
    	if (dao.save(jgdmSave)) {
    		fddbr.setJgmc(jgdmSave.getJgmc());
    		AddFddbr(fddbr,jgdmSave.getId().toString(),frjl);
    		return 1;
    	} else
    		return 0;
    }
    public int AddFddbr(TFddbr fddbr,String dm,TFrjl frjl) {
    	fddbr.setCsrq(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getCsrq()))).getTime()));
    	fddbr.setRzsj(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getRzsj()))).getTime()));
    	fddbr.setRhsj(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getRhsj()))).getTime()));
    	fddbr.setStatus("0");
    	fddbr.setTyshxydm(dm);
    	if(dao.save(fddbr)){
    		if(frjl!=null){
    		frjl.setFrId(fddbr.getLsh());
    		dao.save(frjl);
    		}
    	}
    	return 0;
    }
    public int updateFddbr(TFddbr fddbr,TJgdm dm,TFrjl frjl) {
    	TFddbr fr=fddbrList(dm.getTyshxydm());
    	if(fr!=null){
    		//delFddbr(dm.getTyshxydm());
    		fr.setCsrq(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getCsrq()))).getTime()));
        	fr.setRzsj(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getRzsj()))).getTime()));
        	fr.setRhsj(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getRhsj()))).getTime()));
        	fr.setStatus("0");
        	fr.setTyshxydm(dm.getTyshxydm());
        	fr.setJgmc(dm.getJgmc());
        	fr.setXm(fddbr.getXm());
        	fr.setXb(fddbr.getXb());
        	fr.setLxmobile(fddbr.getLxmobile());
        	fr.setLxdh(fddbr.getLxdh());
        	fr.setMz(fddbr.getMz());
        	fr.setXl(fddbr.getXl());
        	fr.setZzmm(fddbr.getZzmm());
        	fr.setTxdz(fddbr.getTxdz());
        	fr.setYb(fddbr.getYb());
        	fr.setEmail(fddbr.getEmail());
        	fr.setZw(fddbr.getZw());
        	fr.setIszz(fddbr.getIszz());
        	fr.setQtzw(fddbr.getQtzw());
        	fr.setZjhm(fddbr.getZjhm());
        	fr.setZjlx(fddbr.getZjlx());
        	if(dao.update(fr)){
        	if(frjl!=null){
        		TFrjl jl=getFrjl(fr.getLsh());
        		if(jl!=null){
        			jl.setRzsj1(frjl.getRzsj1());
        			jl.setZw1(frjl.getZw1());
        			jl.setGzdw1(frjl.getGzdw1());
        			jl.setRzsj2(frjl.getRzsj2());
        			jl.setZw2(frjl.getZw2());
        			jl.setGzdw2(frjl.getGzdw2());
        			jl.setRzsj3(frjl.getRzsj3());
        			jl.setZw3(frjl.getZw3());
        			jl.setGzdw3(frjl.getGzdw3());
        			jl.setRzsj4(frjl.getRzsj4());
        			jl.setZw4(frjl.getZw4());
        			jl.setGzdw4(frjl.getGzdw4());
        			jl.setRzsj5(frjl.getRzsj5());
        			jl.setZw5(frjl.getZw5());
        			jl.setGzdw5(frjl.getGzdw5());
        			jl.setRzsj6(frjl.getRzsj6());
        			jl.setZw6(frjl.getZw6());
        			jl.setGzdw6(frjl.getGzdw6());
        			jl.setRzsj7(frjl.getRzsj7());
        			jl.setZw7(frjl.getZw7());
        			jl.setGzdw7(frjl.getGzdw7());
        			jl.setRzsj8(frjl.getRzsj8());
        			jl.setZw8(frjl.getZw8());
        			jl.setGzdw8(frjl.getGzdw8());
        			
        			dao.update(jl);
        		}else{
        			frjl.setFrId(fr.getLsh());
        			dao.save(frjl);
        		}
        	  }
        	}
    ...
    public int updateFddbrSave(TFddbr fddbr,TJgdmSave dm,TFrjl frjl) {
    	TFddbr fr=fddbrList(dm.getId().toString());
    	if(fr!=null){
    		//delFddbr(dm.getTyshxydm());
    		fr.setCsrq(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getCsrq()))).getTime()));
        	fr.setRzsj(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getRzsj()))).getTime()));
        	fr.setRhsj(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getRhsj()))).getTime()));
        	fr.setStatus("0");
        	fr.setTyshxydm(dm.getId().toString());
        	fr.setJgmc(dm.getJgmc());
        	fr.setXm(fddbr.getXm());
        	fr.setXb(fddbr.getXb());
        	fr.setLxmobile(fddbr.getLxmobile());
    ...
    public int AddFddbr(EntityManager em,TFddbr fddbr,TJgdm dm,TFrjl frjl) {
    	fddbr.setCsrq(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getCsrq()))).getTime()));
    	fddbr.setRzsj(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getRzsj()))).getTime()));
    	fddbr.setRhsj(new Timestamp((DateUtil.strToDate(DateUtil.dateToStr(fddbr.getRhsj()))).getTime()));
    	fddbr.setStatus("0");
    	fddbr.setTyshxydm(dm.getTyshxydm());
    	fddbr.setJgmc(dm.getJgmc());
    	em.persist(fddbr);
    		if(frjl!=null){
    		frjl.setFrId(fddbr.getLsh());
    		em.persist(frjl);
    ...
    public int AddTjgdmFddbr(EntityManager em,TFddbr fzr,String  tydm) {
    	System.out.println(fzr.toString());
    	if(fzr==null){
    		delFzr(em,null,tydm.toString());
    		return 1;
    	}
    	...
    	for(int i=0;i<names.length;i++){
    		...
    		//fzrValue.setGj(getArr(fzr.getGj(),i));
    		fzrValue.setZzmm(getArr(fzr.getZzmm(),i));
    		fzrValue.setRzsj(new java.sql.Date( fzr.getRzsj().getTime()));
    		fzrValue.setRhsj(new java.sql.Date( fzr.getRhsj().getTime()));
    		//fzrValue.setDzdw(fzr.getd,i);
    		fzrValue.setLxdh(getArr(fzr.getLxdh(),i));
    		fzrValue.setYb(getArr(fzr.getYb(),i));
    		fzrValue.setZjlx(getArr(fzr.getZjlx(),i));
    		fzrValue.setZjhm(getArr(fzr.getZjhm(),i));
    ...
    public List<TFddbr> fzrList(String id){
    	try {
    		List<TFddbr> instances = EntityManagerHelper.getEntityManager().createQuery("SELECT model from TFzr  model where model.tyshxydm =:tyshxydm")
    		.setParameter("tyshxydm", id).getResultList();
    		return instances;
    ...
    public TFddbr fddbrList(String id){
    	try {
    		List<TFddbr> instances = EntityManagerHelper.getEntityManager().createQuery("SELECT model from TFddbr  model where model.tyshxydm =:tyshxydm and status='0'")
    		.setParameter("tyshxydm", id).getResultList();
    		TFddbr fddbr=null;
    		if(instances.size()>0){
    		 fddbr=instances.get(0);
    		}
    		return fddbr;
    	} catch (RuntimeException re) {
    		throw re;
    ...
    public TFddbr fddbrList(EntityManager em,String id){
    	try {
    		List<TFddbr> instances = em.createQuery("SELECT model from TFddbr  model where model.tyshxydm =:tyshxydm and status='0'")
    		.setParameter("tyshxydm", id).getResultList();
    		TFddbr fddbr=null;
    		if(instances.size()>0){
    		 fddbr=instances.get(0);
    		 System.err.println("instances.size()"+instances.size());
    		 System.err.println("fddbr"+fddbr);
    		}
    		return fddbr;
    	} catch (RuntimeException re) {
    		throw re;
    ...
    public int updateFddbr(EntityManager em,String id){
    	try {
    	em.createQuery("update TFddbr set status='1' where tyshxydm =:tyshxydm")
    		.setParameter("tyshxydm", id).executeUpdate();
    		return 0;
    	} catch (RuntimeException re) {
    		throw re;
    	} 
    ...
    public TFrjl getFrjl(EntityManager em,Integer id){
    	try {
    		/*List<TFrjl> instances = em.createQuery("SELECT model from TFrjl  model where model.frId =:id")
    ...
    public TFrjl getFrjl(Integer id){
    	try {
    		List<TFrjl> instances = EntityManagerHelper.getEntityManager().createQuery("SELECT model from TFrjl  model where model.frId =:tyshxydm")
    		.setParameter("tyshxydm", id).getResultList();
    		TFrjl frjl=null;
    		if(instances.size()>0){
    		 frjl=instances.get(0);
    ...
    public boolean delFddbr(String tydm) {
        boolean flag = true;
        EntityManager em = EntityManagerHelper.getEntityManager();
        em.clear();
        EntityTransaction tx = em.getTransaction();
        try {
            ...
            String sql="";
            	...
            	sql="delete TFddbr model where  model.tyshxydm=:tydm";
    ...
    public boolean delFrjl(String tydm) {
        boolean flag = true;
        EntityManager em = EntityManagerHelper.getEntityManager();
        em.clear();
        EntityTransaction tx = em.getTransaction();
        try {
            ...
            String sql="";
            	...
            	sql="delete TFjl model where  model.frId=:tydm";
    ...
    public boolean delFzr(EntityManager em,String lsh,String tydm) {
    	boolean flag = true;
    		...
    		if(lsh==null||"".equals(lsh)){
    			...
    			sql="delete TFddbr model where model.lsh not in("+lsh+") and model.tyshxydm=:tydm";
    ...
    public boolean upFzr(String id,String tydm) {
    	...
    	try {
    		tx.begin();
    		em.createQuery("update TFddbr model set model.tyshxydm=:tydm where model.tyshxydm=:id and model.status='0'").setParameter("tydm", tydm).setParameter("id", id).executeUpdate();
    		tx.commit();
    	} catch (Exception e) {
    		flag = false;
    		if (tx != null && tx.isActive()) {
    ...
    public int updateTjgdmSave(TJgdmSave jgdmSave,TFddbr fr,TFrjl jl) {
    	if (dao.update(jgdmSave)) {
    		updateFddbrSave(fr,jgdmSave,jl);
    		return 1;
    	} else
    		return 0;
    }
        ...
        try {
            ...
            cond = handleBus.sql(user);
             if ("0".equals(formType)) {
            	...
            	jql = "select model.id,model.tyshxydm,model.jgmc,model.bzrq,s.flag,s.shflag,model.fddbr,model.zjhm,model.jgdm from t_jgdm_save model left join (select tyshxydm,flag,shflag from  t_sp  where  flag !=2 and ywlx in ('07','11','13','15') ) s on convert(varchar,model.id) = s.tyshxydm where "+cond;
            	
            }else{
            	jql = "select model.id,model.tyshxydm,model.jgmc,model.bzrq,s.flag,s.shflag,model.fddbr,model.zjhm,model.jgdm from t_jgdm_save model left join (select tyshxydm,flag,shflag from  t_sp  where  flag !=2 and ywlx in ('07','11','13','15') ) s on model.jgdm = ltrim(s.tyshxydm) where "+cond;
     ...
     */
    public synchronized String revision(String id, String formType, User user ,String jglx,String sslcode) {
        Integer result = 0;
          ...
          /*  List qzList = new TQzjgdmDAO().findbysql("select jgdm from t_qzjgdm where jgdm = '" + codeId + "' and qzbz != '0'");
            ...
            if (result != 3) {
              ...
              /*  //预赋码
                ...
                jglx = jgdmSave.getJglx();
                //tydm=demo.getCheckCode(lx+"1"+xzqh.trim()+codeId);
                tydm=demo.getCheckCode(lx+jglx+xzqh.trim()+codeId);
                tyxydm=tydm;
                jgdm.setTyshxydm(tydm);
                jgdm.setLastdate(new Date());               
                jgdm.setDybz("0");
                
                //lvwei 20180103 上报字段。arch_Id添加
                jgdm.setDflag(0);
                UUID uuid=UUID.randomUUID();
                jgdm.setArch_Id(uuid.toString());
                jgdm.setYwlx("0");//0新增  1变更  2注销
...
//            sql = "SELECT jgdm,jgmc,fddbr,bzjgdm,'注销库' AS sjly,'t_fzdm' AS tablename,zjhm,fzrq,zch,tyshxydm FROM t_fzdm WHERE " + type + "= '" + value + "' ORDER BY zjhm";
            sql = "SELECT jgdm,jgmc,fddbr,bzjgdm,'注销库' AS sjly,'t_fzdm' AS tablename,zjhm,zch,tyshxydm FROM t_fzdm WHERE " + type + "= '" + value + "' ORDER BY zjhm";
            query = em.createNativeQuery(sql);
            returnList = query.getResultList();
            if (returnList != null && returnList.size() > 0) {
                TjgdmCommon vo = null;
