...
@Entity
@Table(name = "t_fzdm")
public class TFzdm implements Serializable {
	...
	@Column(name = "sqzxrq", length = 23)
	public Date getSqzxrq() {
		return this.sqzxrq;
	}

	public void setSqzxrq(Date sqzxrq) {
		this.sqzxrq = sqzxrq;
	}

	@Column(name = "sjghmc")
	public String getSjghmc() {
		return this.sjghmc;
	}

	public void setSjghmc(String sjghmc) {
		this.sjghmc = sjghmc;
	}

	@Column(name = "dwzxyy", length = 500)
	public String getDwzxyy() {
		return this.dwzxyy;
	}

	public void setDwzxyy(String dwzxyy) {
		this.dwzxyy = dwzxyy;
	}

	@Column(name = "dwzxrq", length = 23)
	public Date getDwzxrq() {
		return this.dwzxrq;
	}

	public void setDwzxrq(Date dwzxrq) {
		this.dwzxrq = dwzxrq;
	}

	@Column(name = "qswbrq", length = 23)
	public Date getQswbrq() {
		return this.qswbrq;
	}

	public void setQswbrq(Date qswbrq) {
		this.qswbrq = qswbrq;
	}

	@Column(name = "pzzxrq", length = 23)
	public Date getPzzxrq() {
		return this.pzzxrq;
	}

	public void setPzzxrq(Date pzzxrq) {
		this.pzzxrq = pzzxrq;
	}

	@Column(name = "zyzxrq", length = 23)
	public Date getZyzxrq() {
		return this.zyzxrq;
	}

	public void setZyzxrq(Date zyzxrq) {
		this.zyzxrq = zyzxrq;
	}
