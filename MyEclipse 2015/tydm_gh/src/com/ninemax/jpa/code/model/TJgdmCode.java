...
public class TJgdmCode {
    ...
    public boolean equals(Object o) {
        ...
        TJgdmCode tJgdmCode = (TJgdmCode) o;

        if (bgbj != null ? !bgbj.equals(tJgdmCode.bgbj) : tJgdmCode.bgbj != null) return false;
        if (bgrq != null ? !bgrq.equals(tJgdmCode.bgrq) : tJgdmCode.bgrq != null) return false;
        if (bzjgdm != null ? !bzjgdm.equals(tJgdmCode.bzjgdm) : tJgdmCode.bzjgdm != null) return false;
        if (bzrq != null ? !bzrq.equals(tJgdmCode.bzrq) : tJgdmCode.bzrq != null) return false;
        if (dhhm != null ? !dhhm.equals(tJgdmCode.dhhm) : tJgdmCode.dhhm != null) return false;
        if (djblx != null ? !djblx.equals(tJgdmCode.djblx) : tJgdmCode.djblx != null) return false;
        if (dybz != null ? !dybz.equals(tJgdmCode.dybz) : tJgdmCode.dybz != null) return false;
        if (email != null ? !email.equals(tJgdmCode.email) : tJgdmCode.email != null) return false;
        if (fbsl != null ? !fbsl.equals(tJgdmCode.fbsl) : tJgdmCode.fbsl != null) return false;
        if (fddbr != null ? !fddbr.equals(tJgdmCode.fddbr) : tJgdmCode.fddbr != null) return false;
        if (fkbz != null ? !fkbz.equals(tJgdmCode.fkbz) : tJgdmCode.fkbz != null) return false;
        if (fksl != null ? !fksl.equals(tJgdmCode.fksl) : tJgdmCode.fksl != null) return false;
        if (gk != null ? !gk.equals(tJgdmCode.gk) : tJgdmCode.gk != null) return false;
        if (gsfzrq != null ? !gsfzrq.equals(tJgdmCode.gsfzrq) : tJgdmCode.gsfzrq != null) return false;
        if (gslsh != null ? !gslsh.equals(tJgdmCode.gslsh) : tJgdmCode.gslsh != null) return false;
        if (gstbr != null ? !gstbr.equals(tJgdmCode.gstbr) : tJgdmCode.gstbr != null) return false;
        if (hbzl != null ? !hbzl.equals(tJgdmCode.hbzl) : tJgdmCode.hbzl != null) return false;
        if (id != null ? !id.equals(tJgdmCode.id) : tJgdmCode.id != null) return false;
        if (importdate != null ? !importdate.equals(tJgdmCode.importdate) : tJgdmCode.importdate != null) return false;
        if (isca != null ? !isca.equals(tJgdmCode.isca) : tJgdmCode.isca != null) return false;
        if (jfly != null ? !jfly.equals(tJgdmCode.jfly) : tJgdmCode.jfly != null) return false;
        if (jgdm != null ? !jgdm.equals(tJgdmCode.jgdm) : tJgdmCode.jgdm != null) return false;
        if (jgdz != null ? !jgdz.equals(tJgdmCode.jgdz) : tJgdmCode.jgdz != null) return false;
        if (jglx != null ? !jglx.equals(tJgdmCode.jglx) : tJgdmCode.jglx != null) return false;
        if (jgmc != null ? !jgmc.equals(tJgdmCode.jgmc) : tJgdmCode.jgmc != null) return false;
        if (jjhy != null ? !jjhy.equals(tJgdmCode.jjhy) : tJgdmCode.jjhy != null) return false;
        if (jjlx != null ? !jjlx.equals(tJgdmCode.jjlx) : tJgdmCode.jjlx != null) return false;
        if (jydh != null ? !jydh.equals(tJgdmCode.jydh) : tJgdmCode.jydh != null) return false;
        if (jydz != null ? !jydz.equals(tJgdmCode.jydz) : tJgdmCode.jydz != null) return false;
        if (jyfw != null ? !jyfw.equals(tJgdmCode.jyfw) : tJgdmCode.jyfw != null) return false;
        if (jyyb != null ? !jyyb.equals(tJgdmCode.jyyb) : tJgdmCode.jyyb != null) return false;
        if (khyh != null ? !khyh.equals(tJgdmCode.khyh) : tJgdmCode.khyh != null) return false;
        if (khzh != null ? !khzh.equals(tJgdmCode.khzh) : tJgdmCode.khzh != null) return false;
        if (lastdate != null ? !lastdate.equals(tJgdmCode.lastdate) : tJgdmCode.lastdate != null) return false;
        if (lry != null ? !lry.equals(tJgdmCode.lry) : tJgdmCode.lry != null) return false;
        if (memo1 != null ? !memo1.equals(tJgdmCode.memo1) : tJgdmCode.memo1 != null) return false;
        if (memo2 != null ? !memo2.equals(tJgdmCode.memo2) : tJgdmCode.memo2 != null) return false;
        if (mobile != null ? !mobile.equals(tJgdmCode.mobile) : tJgdmCode.mobile != null) return false;
        if (njjhy != null ? !njjhy.equals(tJgdmCode.njjhy) : tJgdmCode.njjhy != null) return false;
        if (njjlx != null ? !njjlx.equals(tJgdmCode.njjlx) : tJgdmCode.njjlx != null) return false;
        if (njqx != null ? !njqx.equals(tJgdmCode.njqx) : tJgdmCode.njqx != null) return false;
        if (njr != null ? !njr.equals(tJgdmCode.njr) : tJgdmCode.njr != null) return false;
        if (njrq != null ? !njrq.equals(tJgdmCode.njrq) : tJgdmCode.njrq != null) return false;
        if (pwrq != null ? !pwrq.equals(tJgdmCode.pwrq) : tJgdmCode.pwrq != null) return false;
        if (pzjgdm != null ? !pzjgdm.equals(tJgdmCode.pzjgdm) : tJgdmCode.pzjgdm != null) return false;
        if (pzjgmc != null ? !pzjgmc.equals(tJgdmCode.pzjgmc) : tJgdmCode.pzjgmc != null) return false;
        if (pzwh != null ? !pzwh.equals(tJgdmCode.pzwh) : tJgdmCode.pzwh != null) return false;
        if (qzbz != null ? !qzbz.equals(tJgdmCode.qzbz) : tJgdmCode.qzbz != null) return false;
        if (qzrq != null ? !qzrq.equals(tJgdmCode.qzrq) : tJgdmCode.qzrq != null) return false;
        if (scbzrq != null ? !scbzrq.equals(tJgdmCode.scbzrq) : tJgdmCode.scbzrq != null) return false;
        if (ssss != null ? !ssss.equals(tJgdmCode.ssss) : tJgdmCode.ssss != null) return false;
        if (tbrlxfs != null ? !tbrlxfs.equals(tJgdmCode.tbrlxfs) : tJgdmCode.tbrlxfs != null) return false;
        if (tbrsfzh != null ? !tbrsfzh.equals(tJgdmCode.tbrsfzh) : tJgdmCode.tbrsfzh != null) return false;
        if (tbrxm != null ? !tbrxm.equals(tJgdmCode.tbrxm) : tJgdmCode.tbrxm != null) return false;
        if (url != null ? !url.equals(tJgdmCode.url) : tJgdmCode.url != null) return false;
        if (wftzgb != null ? !wftzgb.equals(tJgdmCode.wftzgb) : tJgdmCode.wftzgb != null) return false;
        if (wjwlsh != null ? !wjwlsh.equals(tJgdmCode.wjwlsh) : tJgdmCode.wjwlsh != null) return false;
        if (wjwtbr != null ? !wjwtbr.equals(tJgdmCode.wjwtbr) : tJgdmCode.wjwtbr != null) return false;
        if (xgr != null ? !xgr.equals(tJgdmCode.xgr) : tJgdmCode.xgr != null) return false;
        if (xzqh != null ? !xzqh.equals(tJgdmCode.xzqh) : tJgdmCode.xzqh != null) return false;
        if (yjflag != null ? !yjflag.equals(tJgdmCode.yjflag) : tJgdmCode.yjflag != null) return false;
        if (yzbm != null ? !yzbm.equals(tJgdmCode.yzbm) : tJgdmCode.yzbm != null) return false;
        if (zbsl != null ? !zbsl.equals(tJgdmCode.zbsl) : tJgdmCode.zbsl != null) return false;
        if (zch != null ? !zch.equals(tJgdmCode.zch) : tJgdmCode.zch != null) return false;
        if (zcrq != null ? !zcrq.equals(tJgdmCode.zcrq) : tJgdmCode.zcrq != null) return false;
        if (zczj != null ? !zczj.equals(tJgdmCode.zczj) : tJgdmCode.zczj != null) return false;
        if (zfrq != null ? !zfrq.equals(tJgdmCode.zfrq) : tJgdmCode.zfrq != null) return false;
        if (zgdm != null ? !zgdm.equals(tJgdmCode.zgdm) : tJgdmCode.zgdm != null) return false;
        if (zgmc != null ? !zgmc.equals(tJgdmCode.zgmc) : tJgdmCode.zgmc != null) return false;
        if (zgrs != null ? !zgrs.equals(tJgdmCode.zgrs) : tJgdmCode.zgrs != null) return false;
        if (zjhm != null ? !zjhm.equals(tJgdmCode.zjhm) : tJgdmCode.zjhm != null) return false;
        if (zjlx != null ? !zjlx.equals(tJgdmCode.zjlx) : tJgdmCode.zjlx != null) return false;
        if (zslsh != null ? !zslsh.equals(tJgdmCode.zslsh) : tJgdmCode.zslsh != null) return false;
        if (zycp1 != null ? !zycp1.equals(tJgdmCode.zycp1) : tJgdmCode.zycp1 != null) return false;
        if (zycp2 != null ? !zycp2.equals(tJgdmCode.zycp2) : tJgdmCode.zycp2 != null) return false;
        if (zycp3 != null ? !zycp3.equals(tJgdmCode.zycp3) : tJgdmCode.zycp3 != null) return false;
