 ...
 * Time: ÏÂÎç2:10
 */
@javax.persistence.Table(name = "t_njjlx")
@Entity
public class TNjjlx {
    private String dm;
    ...
    public boolean equals(Object o) {
        ...
        TNjjlx tNjjlx = (TNjjlx) o;

        if (dm != null ? !dm.equals(tNjjlx.dm) : tNjjlx.dm != null) return false;
        if (mc != null ? !mc.equals(tNjjlx.mc) : tNjjlx.mc != null) return false;
