...
public class Org implements Serializable {
	...
	public String getAdudit_userid() {
		return adudit_userid;
	}
	public void setAdudit_userid(String adudit_userid) {
		this.adudit_userid = adudit_userid;
	}
	
	public String getAdudit_username() {
		return adudit_username;
	}
	public void setAdudit_username(String adudit_username) {
		this.setAdudit_username(adudit_username);
	}
	
	public String getAdudit_name() {
		return adudit_name;
	}
	public void setAdudit_name(String adudit_name) {
		this.adudit_name = adudit_name;
	}
	
	public Date getAdudit_date() {
		return adudit_date;
	}
	public void setAdudit_date(Date adudit_date) {
		this.adudit_date = adudit_date;
	}
	
	public String getAdudit_note() {
		return adudit_note;
	}
	public void setAdudit_note(String adudit_note) {
